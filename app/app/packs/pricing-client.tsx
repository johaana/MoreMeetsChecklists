...
const Checkbox = (props: React.InputHTMLAttributes<HTMLInputElement> & { onCheckedChange?: (checked: boolean) => void }) => (
    <input type="checkbox" onChange={(e) => props.onCheckedChange?.(e.target.checked)} {...props} />
);
