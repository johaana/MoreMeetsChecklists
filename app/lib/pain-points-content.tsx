...
export const painPointsContent: Record<string, PainPointContent> = {
    ...
    theme_park_ops_pack: {
        ...
        points: [
            ...
            { icon: Bug, title: "Action Park (USA, 1980s-9s)", description: "Dubbed 'Class Action Park,' this venue was notorious for poorly designed rides and untrained staff, leading to multiple deaths. Our checklists for ride design, operator training, and daily safety audits are the antidote to such a catastrophic operational culture." },
