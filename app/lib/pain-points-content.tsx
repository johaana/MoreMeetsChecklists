...
import { Bug, Siren, Wrench, Recycle, Eye, TrendingUp, KeyRound, Zap, Shield, Lock, FileLock, Users, Banknote, Bus, TestTube, Building2, Factory, FileCheck, Stethoscope, Sparkles, Home, ClipboardList, Syringe, Gem, CircleDollarSign, Watch, UserCheck, Popcorn, Projector, Ticket, Building, LifeBuoy, Utensils, HardHat, Pill, Barcode, CakeSlice, Thermometer, Package, Store, EyeIcon, DollarSign, BookOpen, Megaphone, Dumbbell, Sprout, Film, Map, Scissors, Video, Cloud, BrainCircuit, DatabaseZap, Handshake, HeartPulse, Star, Globe, Award, BriefcaseBusiness, FerrisWheel } from 'lucide-react';
...
export const painPointsContent: Record<string, PainPointContent> = {
    bakery_confectionery_pack: {
     ...
     franchise_operations_pack: {
        ...
        disclaimer: "*The following real-world incidents are cited based on publicly available news reports and investigation findings for educational and illustrative purposes only.*",
        points: [
            { icon: EyeIcon, title: "The Brand Dilution Disaster (Subway's 'Footlong' Scandal, USA)", description: "Multiple Subway franchisees were caught using bread shorter than 11 inches, leading to class-action lawsuits and a PR crisis that damaged the brand's core promise. Our 'Brand Audit' and 'Supply Chain SOPs' enforce portion control and supplier compliance, protecting your brand integrity." },
