...
export const painPointsContent = {
    ...
    franchise_operations_pack: {
        ...
        disclaimer: "*The following real-world incidents are cited based on publicly available news reports and investigation findings for educational and illustrative purposes only.*",
        points: [
            { icon: <TrendingUp />, title: "The Royalty Leakage Crisis (Generic QSR)", description: "Franchisees using off-book sales and aggregator bill-cancellation hacks can silently erode 20% of franchisor royalty streams. Our 'Royalty Shield' SOP uses mandatory bill seriality checks to plug these holes." },
