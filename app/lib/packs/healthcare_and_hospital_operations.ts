...
export const healthcare_and_hospital_operations: PremiumPack = {
    ...
    priceUSD: 9,
    category: "Healthcare",
    description: "The Sovereign v8.5 clinical engine for hospitals and specialized medical centers. Hardening 200+ control points from surgical safety to biomedical waste.",
