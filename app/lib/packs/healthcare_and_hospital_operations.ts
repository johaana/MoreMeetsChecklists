...
export const healthcare_and_hospital_operations: PremiumPack = {
    ...
    checklists: [
        ...
        },
        {
            ...
            icon: "stethoscope",
            tasks: [
                { id: "H-OPD-01", description: "Verify doctor arrival time parity against scheduled OPD slots.", priority: "High", riskLevel: "Low", consequence: "Patient frustration and increased queue TAT.", proof: "Attendance Log" },
                { id: "H-OPD-02", description: "Audit diagnostic report TAT: Check if reports are delivered within promised hours.", priority: "High", riskLevel: "Medium", consequence: "Delayed diagnosis and clinical risk.", proof: "TAT Dashboard" },
                { id: "H-OPD-03", description: "Verify calibration of OPD vitals equipment (BP, Weight, Pulse-Ox).", priority: "Medium", riskLevel: "Medium", consequence: "Incorrect clinical readings leading to wrong treatment.", proof: "Calibration Sticker" },
                { id: "H-OPD-04", description: "Inspect OPD consultation rooms for hygiene and stock (gloves, sheets).", priority: "Medium", riskLevel: "Low", consequence: "Infection risk and poor brand perception.", proof: "Visual Check" },
                { id: "H-OPD-05", description: "Check availability of patient info materials: health plans, maps.", priority: "Low", riskLevel: "Low", consequence: "Patient confusion.", proof: "Stock Check" }
            ]
        },
        {
            ...
            icon: "banknote",
            tasks: [
                { id: "H-DIS-01", description: "Pre-Discharge Audit: Verify all diagnostic tests and medicines are billed.", priority: "High", riskLevel: "High", consequence: "Silent profit leakage through unbilled consumables.", proof: "Reconciliation Sheet" },
                { id: "H-DIS-02", description: "Insurance/TPA Clearance: Confirm pre-auth or final approval status.", priority: "High", riskLevel: "High", consequence: "Unrecoverable financial loss and payment defaults.", proof: "System Approval" },
                { id: "H-DIS-03", description: "Bedside Medication Handover: Verify patient understands post-discharge meds.", priority: "High", riskLevel: "Medium", consequence: "Readmission due to incorrect medication usage at home.", proof: "Handover Note" },
                { id: "H-DIS-04", description: "Discharge Summary Verification: Ensure doctor sign-off and clarity.", priority: "High", riskLevel: "High", consequence: "Legal liability and clinical confusion during follow-up.", proof: "Signed Summary" },
                { id: "H-DIS-05", description: "Exit Feedback Pulse: Verbal or digital feedback from every departing patient.", priority: "Medium", riskLevel: "Low", consequence: "Negative OTA reviews and missed recovery.", proof: "Feedback Log" }
            ]
        },
        {
            ...
            icon: "plane",
            tasks: [
                { id: "H-AIR-01", description: "Landing Zone (LZ) Safety Audit: Clear debris and check perimeter security.", priority: "High", riskLevel: "High", consequence: "Catastrophic crash or rotor-blade accident.", proof: "Visual Sign-off" },
                { id: "H-AIR-02", description: "Flight Medical Kit: Verify ventilator, AED, and specialized O2 full status.", priority: "High", riskLevel: "High", consequence: "Patient death during transport due to equipment failure.", proof: "Seal Verification" },
                { id: "H-AIR-03", description: "Crew Sync Briefing: Pilot, Medic, and Receiving Unit coordination.", priority: "High", riskLevel: "High", consequence: "Delayed clinical handover during the golden hour.", proof: "Briefing Log" },
                { id: "H-AIR-04", description: "In-flight Communication Test: Verify link between transport and ICU.", priority: "High", riskLevel: "Medium", consequence: "Inability to relay critical clinical changes.", proof: "Comm Test" },
                { id: "H-AIR-05", description: "Hazardous Weather Monitoring: Log official aviation clearance.", priority: "High", riskLevel: "High", consequence: "Flight disaster risk.", proof: "Weather Report" }
            ]
        },
        {
        ...
        },
        {
            ...
            tasks: [
                ...
                { id: "H-FB-04", description: "Audit staff hygiene: health check, masks, and gloves.", priority: "High", riskLevel: "High", consequence: "Contamination of patient food.", proof: "Daily Log" }
            ]
        },
        {
        ...
        },
        {
            ...
            tasks: [
                ...
                { id: "H-SE-02", description: "Visitor Badge Enforcement: Audit entry/exit points.", priority: "Medium", riskLevel: "Low", consequence: "Unauthorized access to sensitive wards.", proof: "Visual Check" },
        ...
        },
        {
            ...
            icon: "truck",
            tasks: [
                { id: "H-SU-01", description: "Vendor Receiving Audit: Check cold-chain monitor tags on incoming biologics.", priority: "High", riskLevel: "High", consequence: "Accepting compromised/ineffective vaccines/implants.", proof: "Receiving Note" },
