    ...
    checklists: [
        {
            ...
            tasks: [
                ...
                { id: "F-MGR-02", technicalProtocol: "Void-Bill Authorization", floorAction: "Audit 100% of bill deletions; verify manager ID login match.", priority: "High", riskLevel: "High", consequence: "Theft masked as cashier errors.", proof: "Void Registry", verificationRequired: true, cadence: "daily" },
        ...
        },
        {
            ...
            tasks: [
                ...
                { id: "F-IRC-06", technicalProtocol: "Gift-Box Inventory", floorAction: "Confirm 50+ medium boxes available for premium line.", priority: "Low", riskLevel: "Low", consequence: "Delayed impulse checkout.", proof: "Stock Check", cadence: "weekly" },
