    ...
    checklists: [
        ...
        },
        {
            ...
            tasks: [
                ...
                { id: "INC-CAPA-05", description: "Assign owners and deadlines for each action in the CAPA plan.", priority: "High", riskLevel: "High", consequence: "Without ownership, actions are never completed.", proof: "CAPA Tracker" },
