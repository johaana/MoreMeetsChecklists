    ...
    checklists: [
        ...
        },
        {
            ...
            tasks: [
                ...
                { id: "FM-NRG-03", technicalProtocol: "Water Leakage Patrol", floorAction: "Check all 4 sub-meters at 3 AM (Target: Zero usage).", priority: "High", riskLevel: "Medium", consequence: "Resource waste and structural decay.", proof: "Leak Log", verificationRequired: true, cadence: "daily" },
