    ...
    checklists: [
        ...
        },
        {
            ...
            tasks: [
                ...
                { id: "HR-LSR-04", description: "Pet-Friendly Audit: Check availability of pet-kits and sanitized bowls.", priority: "Medium", riskLevel: "Low", consequence: "Service failure for premium niche.", proof: "Stock Check" }
            ]
        },
        {
        ...
        },
        {
            ...
            tasks: [
                ...
                { id: "HR-ENG-04", description: "Test fire alarm panel and smoke detector samples.", priority: "High", riskLevel: "High", consequence: "Fatal delay in emergency.", proof: "Alarm Test Log" }
            ]
        },
        {
            ...
            tasks: [
                ...
                { id: "HR-VIP-03", description: "Handle and log all guest escalations immediately.", priority: "High", riskLevel: "High", consequence: "Legal/PR risk.", proof: "Incident Log" }
            ]
        },
        {
            ...
            tasks: [
                ...
                { id: "HR-SUP-03", description: "Blind Inventory Count: Random audit of high-value items.", priority: "High", riskLevel: "High", consequence: "Internal theft.", proof: "Stock Sheet" }
            ]
        }
    ]
};
