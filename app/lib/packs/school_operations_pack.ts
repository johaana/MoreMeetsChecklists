...
export const school_operations_pack: PremiumPack = {
    ...
    checklists: [
        ...
        },
        {
            ...
            icon: "utensils",
            tasks: [
                { id: "SC-FB-01", description: "Log temperature of incoming raw milk and protein.", priority: "High", riskLevel: "High", consequence: "Mass food poisoning outbreak.", proof: "Digital Log", trainerNotes: "Milk must be < 4°C." },
                { id: "SC-FB-02", description: "Audit expiry dates of all pantry items.", priority: "High", riskLevel: "High", consequence: "Serving expired food to children.", proof: "Sweep Report", trainerNotes: "Discard anything expiring today." },
                { id: "SC-FB-03", description: "Verify cooking oil quality and replacement schedule.", priority: "Medium", riskLevel: "Low", consequence: "Long-term health impact and poor quality.", proof: "Titration Log", trainerNotes: "Target TPC < 25%." },
                { id: "SC-FB-04", description: "Check dishwashing water temperature (Min 82°C).", priority: "High", riskLevel: "Medium", consequence: "Bacterial transmission via utensils.", proof: "Temp Reading", trainerNotes: "Use digital probe." }
            ]
        },
        {
            ...
            icon: "heart-pulse",
            tasks: [
                { id: "SC-MED-01", description: "Verify emergency drug kit is in-date and stocked.", priority: "High", riskLevel: "High", consequence: "Delayed response to an anaphylactic or diabetic shock.", proof: "Stock Check", trainerNotes: "Check Epipen expiry dates." },
                { id: "SC-MED-02", description: "Audit daily medication administration logs for students with chronic needs.", priority: "High", riskLevel: "High", consequence: "Missed doses or incorrect administration.", proof: "Med Registry", trainerNotes: "Double-verify student ID." },
                { id: "SC-MED-03", description: "Inspect all classroom hand-sanitizer stations.", priority: "Low", riskLevel: "Low", consequence: "Increased spread of seasonal viral infections.", proof: "Visual Check", trainerNotes: "Refill weekly on Fridays." }
            ]
        },
        {
            ...
            icon: "file-lock",
            tasks: [
                { id: "SC-ADM-01", description: "Verify fire-safety certificate and lift-license validity.", priority: "High", riskLevel: "High", consequence: "Legal closure and massive fines.", proof: "Registry Check", trainerNotes: "Submit renewal 60 days early." },
                { id: "SC-ADM-02", description: "Audit staff background checks (Police Verification) for new hires.", priority: "High", riskLevel: "High", consequence: "Hiring at-risk individuals (Never-event).", proof: "HR File Audit", trainerNotes: "Verify original documents only." },
                { id: "SC-ADM-03", description: "Update 'Crisis Management' contact tree.", priority: "Medium", riskLevel: "Low", consequence: "Confusion during a real emergency.", proof: "Updated List", trainerNotes: "Print and post in the office." }
            ]
        },
        {
            ...
            icon: "users",
            tasks: [
                { id: "SC-PR-01", description: "Log and track all parent complaints to resolution within 48h.", priority: "High", riskLevel: "Medium", consequence: "Escalation to legal or viral social media risk.", proof: "Complaint Log", trainerNotes: "Close loop with a phone call." },
                { id: "SC-PR-02", description: "Verify that all daily 'School-to-Parent' messages are sent.", priority: "Medium", riskLevel: "Low", consequence: "Parent anxiety and communication gap.", proof: "App Log", trainerNotes: "Post by 4 PM daily." }
            ]
        },
        {
            ...
            icon: "wrench",
            tasks: [
                { id: "SC-FAC-01", description: "Playground Audit: Check for rusted swings or loose bolts.", priority: "High", riskLevel: "High", consequence: "Serious injury to child during play.", proof: "Safety Report", trainerNotes: "Shake every swing manually." },
                { id: "SC-FAC-02", description: "Inspect water tank hygiene and verify cleaning cycle.", priority: "High", riskLevel: "Medium", consequence: "Water-borne disease outbreak.", proof: "Cleaning Certificate", trainerNotes: "Audit tank covers for cracks." },
                { id: "SC-FAC-03", description: "Check electrical panels for loose wiring or hotspots.", priority: "High", riskLevel: "High", consequence: "Short-circuit fire.", proof: "Visual Audit", trainerNotes: "Lock panels at all times." }
            ]
        },
        {
            ...
            icon: "test-tube",
            tasks: [
                { id: "SC-LAB-01", description: "Audit the 'Poison/Acid' cabinet for secure locks.", priority: "High", riskLevel: "High", consequence: "Theft or misuse of hazardous chemicals.", proof: "Visual Sign-off", trainerNotes: "Only 2 key holders allowed." },
                { id: "SC-LAB-02", description: "Verify all eyewash stations are functional.", priority: "High", riskLevel: "High", consequence: "Permanent injury after a lab accident.", proof: "Test Log", trainerNotes: "Run water for 10 seconds." }
            ]
        },
        {
            ...
            icon: "user-check",
            tasks: [
                { id: "SC-HR-01", description: "Verify 100% staff have attended the 'Emergency Drill' training.", priority: "High", riskLevel: "High", consequence: "Chaos during an evacuation.", proof: "Training Matrix", trainerNotes: "Check new joiners specifically." },
                { id: "SC-HR-02", description: "Audit teacher substitution logs for class coverage parity.", priority: "Medium", riskLevel: "Low", consequence: "Unsupervised classrooms.", proof: "Roster Audit", trainerNotes: "Check morning log by 8:30 AM." }
            ]
        },
        {
            ...
            icon: "banknote",
            tasks: [
                { id: "SC-FIN-01", description: "Reconcile daily fee collections against bank deposits.", priority: "High", riskLevel: "High", consequence: "Internal theft and revenue leakage.", proof: "Reconciliation Sheet", trainerNotes: "Check cash-vault daily." },
                { id: "SC-FIN-02", description: "Audit outstanding vendor payments against AMCs.", priority: "Medium", riskLevel: "Low", consequence: "Lapse in service for critical infrastructure.", proof: "Payment File", trainerNotes: "Release payments on time." }
            ]
        }
    ]
};
