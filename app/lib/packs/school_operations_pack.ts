    ...
    checklists: [
        {
            ...
            tasks: [
                ...
                { id: "S-EXE-10", technicalProtocol: "Daily MOD Sign-off", floorAction: "Final daily summary of campus status and incidents.", priority: "High", riskLevel: "Low", consequence: "Governance gap.", proof: "Signed Summary", verificationRequired: true, cadence: "daily" }
            ]
        },
        {
            ...
            tasks: [
                ...
                { id: "H-VP-10", technicalProtocol: "Shift Handover Verify", floorAction: "Digital sign-off on afternoon duties for the closing admin.", priority: "Medium", riskLevel: "Low", consequence: "Lost instructions.", proof: "Handover Log", cadence: "daily" }
            ]
        },
        {
        ...
        },
        {
            ...
            icon: "file-lock",
            tasks: [
                { id: "S-EXM-01", technicalProtocol: "Paper Custody Seal", floorAction: "Physically witness sealing of paper envelopes in the vault.", priority: "High", riskLevel: "High", consequence: "Exam leak and total re-conduct cost.", proof: "Seal Registry", verificationRequired: true, cadence: "incident-based" },
                { id: "S-EXM-02", technicalProtocol: "Invigilator Positioning", floorAction: "Verify staff presence matches the board-spec duty roster.", priority: "High", riskLevel: "Medium", consequence: "Examination malpractice.", proof: "Attendance Log", cadence: "daily" },
                ...
                { id: "S-EXM-04", technicalProtocol: "Digital Clock Sync", floorAction: "Verify hall clocks match the official start-time master.", priority: "Medium", riskLevel: "Low", consequence: "Disputes over exam duration.", proof: "Visual Check", cadence: "daily" },
        ...
        },
        {
            ...
            tasks: [
                ...
                { id: "S-OPS-04", technicalProtocol: "Event Safety Permit", floorAction: "Review floor plan for upcoming Annual Day for fire-lane clear.", priority: "High", riskLevel: "High", consequence: "Fire hazard during high-occupancy event.", proof: "Permit Note", verificationRequired: true, cadence: "weekly" },
                ...
                { id: "S-OPS-06", technicalProtocol: "Store Inventory Pulse", floorAction: "Reconcile issue of 10 random stationery SKUs.", priority: "Medium", riskLevel: "Low", consequence: "Internal administrative shrinkage.", proof: "Audit Sheet", cadence: "weekly" },
                { id: "S-OPS-07", technicalProtocol: "Canteen Audit (Admin)", floorAction: "Verify FSSAI license display and hygiene certificate validity.", priority: "High", riskLevel: "High", consequence: "Regulatory closure.", proof: "License File", verificationRequired: true, cadence: "weekly" },
                { id: "S-OPS-08", technicalProtocol: "Campus Perimeter Scan", floorAction: "Identify and fix any loose boundary wall/fence sections.", priority: "High", riskLevel: "High", consequence: "Unauthorized intruder access.", proof: "Walk Log", verificationRequired: true, cadence: "weekly" },
                ...
                { id: "S-OPS-10", technicalProtocol: "EOD Campus Lockdown", floorAction: "Witness lock of all computer labs and science vaults.", priority: "High", riskLevel: "High", consequence: "Overnight high-value asset theft.", proof: "Closure Log", verificationRequired: true, cadence: "daily" }
            ]
        },
        {
            ...
            icon: "users",
            tasks: [
                { id: "S-DIS-01", technicalProtocol: "Bullying Signal Scan", floorAction: "Review peer-conflict logs for recurring patterns or names.", priority: "High", riskLevel: "High", consequence: "Undetected student trauma and parent lawsuit.", proof: "Conflict Registry", verificationRequired: true, cadence: "daily" },
                ...
                { id: "S-DIS-04", technicalProtocol: "Digital Behavior Audit", floorAction: "Review reported instances of cyber-bullying or chat-room issues.", priority: "High", riskLevel: "High", consequence: "Out-of-hours student harm.", proof: "Incident Note", verificationRequired: true, cadence: "daily" },
                { id: "S-DIS-05", technicalProtocol: "Confiscated Item Log", floorAction: "Match physical items in locker to the 'Seizure Registry'.", priority: "Medium", riskLevel: "Low", consequence: "Parent disputes over lost property.", proof: "Locker Match", cadence: "weekly" },
                ...
                { id: "S-DIS-07", technicalProtocol: "Restorative Justice Loop", floorAction: "Conduct 1-on-1 counseling for students involved in yesterday's fight.", priority: "Medium", riskLevel: "Low", consequence: "Repeated behavioral failure.", proof: "Counseling Note", cadence: "daily" },
                ...
                { id: "S-DIS-09", technicalProtocol: "Escalated Parent Huddle", floorAction: "Lead mediation meeting for 2-party student conflict.", priority: "High", riskLevel: "Medium", consequence: "PR crisis and police involvement.", proof: "Meeting Minutes", cadence: "incident-based" },
                { id: "S-DIS-10", technicalProtocol: "EOD Discipline Summary", floorAction: "Final log of 'Behavior Incident Points' for the day.", priority: "Low", riskLevel: "Low", consequence: "Zero trend visibility for Principal.", proof: "Signed Sheet", cadence: "daily" }
            ]
        },
        {
            ...
            icon: "bus",
            tasks: [
                { id: "S-TMG-01", technicalProtocol: "Driver Sobriety Pulse", floorAction: "Execute random breathalyzer test for 5 incoming drivers.", priority: "High", riskLevel: "High", consequence: "Catastrophic crash liability (Fatal).", proof: "Test Note", verificationRequired: true, cadence: "daily" },
                { id: "S-TMG-02", technicalProtocol: "License Validity Sync", floorAction: "Identify any driver/attendant with license expiry < 30 days.", priority: "High", riskLevel: "High", consequence: "Mass legal liability and insurance denial.", proof: "Registry File", verificationRequired: true, cadence: "weekly" },
                ...
                { id: "S-TMG-05", technicalProtocol: "RTO Permit Audit", floorAction: "Confirm 100% active status of 'Yellow Plate' institutional permits.", priority: "High", riskLevel: "High", consequence: "Vehicle seizure by authorities.", proof: "Permit File", verificationRequired: true, cadence: "monthly" },
                { id: "S-TMG-06", technicalProtocol: "Fuel Card Reconcile", floorAction: "Match fuel liters billed vs KM traveled for 10 vehicles.", priority: "Medium", riskLevel: "Medium", consequence: "Fuel theft and profit leakage.", proof: "Audit Report", cadence: "weekly" },
                { id: "S-TMG-07", technicalProtocol: "Driver Briefing", floorAction: "Conduct 5-min huddle on 'No-Honking Zone' compliance.", priority: "Low", riskLevel: "Low", consequence: "Noise complaints and brand damage.", proof: "Briefing Log", cadence: "daily" },
                ...
                { id: "S-TMG-09", technicalProtocol: "Incident Post-Mortem", floorAction: "Analyze root-cause for any 'Minor Dent' or fender-bender.", priority: "Medium", riskLevel: "Medium", consequence: "Repeated safety failure.", proof: "Analysis Log", cadence: "incident-based" },
        ...
        },
        {
            ...
            icon: "bus-front",
            tasks: [
                { id: "S-BRS-01", technicalProtocol: "Boarding ID Match", floorAction: "Verify 100% of student IDs match the route master list.", priority: "High", riskLevel: "Medium", consequence: "Unauthorized student on board.", proof: "Registry Entry", cadence: "daily" },
                { id: "S-BRS-02", technicalProtocol: "Attendance SMS Pulse", floorAction: "Log boarding status; verify automated parent alerts sent.", priority: "Medium", riskLevel: "Low", consequence: "Parental anxiety and trust loss.", proof: "System Sync", cadence: "daily" },
                { id: "S-BRS-03", technicalProtocol: "Emergency Kit Check", floorAction: "Verify presence of medicine box and functional fire extinguisher.", priority: "High", riskLevel: "High", consequence: "Inability to treat on-route injury.", proof: "Visual Check", verificationRequired: true, cadence: "daily" },
                ...
                { id: "S-BRS-05", technicalProtocol: "No-Child-Left-Behind", floorAction: "Physically touch the back seat of the bus post-route.", priority: "High", riskLevel: "High", consequence: "[Fatal never-event: Entrapment].", proof: "Walkthrough Log", verificationRequired: true, cadence: "daily" },
                { id: "S-BRS-06", technicalProtocol: "Female Attendant Presence", floorAction: "Confirm on-board position of designated matron.", priority: "High", riskLevel: "High", consequence: "POCSO / Legal non-compliance.", proof: "Visual Audit", verificationRequired: true, cadence: "daily" },
                { id: "S-BRS-07", technicalProtocol: "Behavior Monitoring", floorAction: "Log any student conflict or bullying instances < 1 hour.", priority: "Medium", riskLevel: "Medium", consequence: "Unresolved bullying during transit.", proof: "Log Note", cadence: "daily" },
                ...
                { id: "S-BRS-09", technicalProtocol: "Hygienic Seat Pulse", floorAction: "Spray sanitizer on high-touch handrails post-trip.", priority: "Low", riskLevel: "Medium", consequence: "Disease spread among fleet.", proof: "Cleaning Sheet", cadence: "daily" },
                { id: "S-BRS-10", technicalProtocol: "Authorized Pickup Vetting", floorAction: "Verify 100% of guardian ID cards before releasing child.", priority: "High", riskLevel: "High", consequence: "Child abduction risk.", proof: "Visual Match", verificationRequired: true, cadence: "daily" }
            ]
        },
        {
            ...
            tasks: [
                ...
                { id: "S-MED-03", technicalProtocol: "Medicine Expiry Audit", floorAction: "Physically check dates on 10 random shelf items.", priority: "Medium", riskLevel: "High", consequence: "Serving ineffective or harmful drugs.", proof: "Expiry Log", cadence: "weekly" },
                { id: "S-MED-04", technicalProtocol: "Nebulizer Sterility", floorAction: "Sanitize masks and verify 100% function.", priority: "Medium", riskLevel: "Medium", consequence: "Bacterial spread via medical tech.", proof: "Cleaning Sheet", cadence: "daily" },
                { id: "S-MED-05", technicalProtocol: "Incident Triage Speed", floorAction: "Log time from 'Call to Infirmary' to 'Nurse Arrival' (Target < 3 mins).", priority: "High", riskLevel: "High", consequence: "Fatal delay in medical aid.", proof: "TAT Dashboard", verificationRequired: true, cadence: "monthly" },
                { id: "S-MED-06", technicalProtocol: "Chronic Student Log", floorAction: "Verify 100% of students on medication have updated logs.", priority: "High", riskLevel: "Medium", consequence: "Missed doses of epilepsy/diabetes meds.", proof: "Patient Chart", verificationRequired: true, cadence: "daily" },
                ...
                { id: "S-MED-08", technicalProtocol: "Sharps Disposal Audit", floorAction: "Verify needle containers are < 75% full and sealed.", priority: "High", riskLevel: "High", consequence: "Needle-stick injury to staff.", proof: "Visual Audit", verificationRequired: true, cadence: "daily" },
                { id: "S-MED-09", technicalProtocol: "Staff First-Aid Pulse", floorAction: "Confirm presence of 2 'Certified Responders' in sports wing.", priority: "Medium", riskLevel: "Low", consequence: "Lack of field-side aid.", proof: "Roster Match", cadence: "daily" },
                { id: "S-MED-10", technicalProtocol: "EOD Medical Summary", floorAction: "Final log of total student visitations and outcomes.", priority: "Low", riskLevel: "Low", consequence: "Zero trend visibility.", proof: "Signed Sheet", cadence: "daily" }
            ]
        },
        {
            ...
            icon: "shield-alert",
            tasks: [
                { id: "S-SAF-01", technicalProtocol: "Fire Exit Clearance", floorAction: "Verify 100% of fire escapes are unlocked and clear.", priority: "High", riskLevel: "High", consequence: "Fatal entrapment during crisis.", proof: "Patrol Log", verificationRequired: true, cadence: "daily" },
                ...
                { id: "S-SAF-05", technicalProtocol: "Lift Emergency Test", floorAction: "Verify ARD rescue logic and intercom functionality.", priority: "High", riskLevel: "High", consequence: "Student entrapment and panic.", proof: "Test Log", verificationRequired: true, cadence: "weekly" },
                { id: "S-SAF-06", technicalProtocol: "Campus Hazard Sweep", floorAction: "Identify loose tiles, sharp corners, or wet stairs.", priority: "Medium", riskLevel: "Medium", consequence: "Student fall injury claims.", proof: "Walkthrough", cadence: "daily" },
                { id: "S-SAF-07", technicalProtocol: "Structural Audit Pulse", floorAction: "Identify wall cracks or settlement in pre-school wing.", priority: "High", riskLevel: "High", consequence: "Building collapse risk.", proof: "Photo Registry", verificationRequired: true, cadence: "monthly" },
                { id: "S-SAF-08", technicalProtocol: "Emergency Signage Lux", floorAction: "Check night visibility of exit signs.", priority: "Medium", riskLevel: "High", consequence: "Disorientation during smoke.", proof: "Visual Audit", cadence: "weekly" },
                ...
                { id: "S-SAF-10", technicalProtocol: "Evacuation Drill Gaps", floorAction: "Confirm closure of 100% of NCs from last drill.", priority: "High", riskLevel: "Medium", consequence: "Repeated safety failure.", proof: "Correction Log", verificationRequired: true, cadence: "monthly" }
            ]
        },
        {
            ...
            icon: "server",
            tasks: [
                { id: "S-IT-01", technicalProtocol: "Content Filter Pulse", floorAction: "Verify blocking of restricted web categories at Lab-1.", priority: "High", riskLevel: "High", consequence: "Student exposure to harmful content.", proof: "System Log", verificationRequired: true, cadence: "daily" },
                { id: "S-IT-02", technicalProtocol: "Smart-board Uptime", floorAction: "Check connectivity and calibration in 5 prime classrooms.", priority: "Low", riskLevel: "Low", consequence: "Teaching interruption.", proof: "Walkthrough", cadence: "daily" },
                { id: "S-IT-03", technicalProtocol: "Cybersecurity Patch", floorAction: "Verify 100% update of server-room security gateway.", priority: "High", riskLevel: "High", consequence: "Ransomware / PII data leak.", proof: "Dashboard Note", verificationRequired: true, cadence: "weekly" },
                { id: "S-IT-04", technicalProtocol: "UPS Battery Pulse", floorAction: "Confirm 15-min backup for the master data switch.", priority: "High", riskLevel: "Medium", consequence: "Campus-wide internet blackout.", proof: "Voltage Log", cadence: "weekly" },
                ...
                { id: "S-IT-06", technicalProtocol: "Student Account Audit", floorAction: "Reset passwords for 10 random student logins.", priority: "Low", riskLevel: "Low", consequence: "Unauthorized account sharing.", proof: "Audit Log", cadence: "weekly" },
                ...
                { id: "S-IT-08", technicalProtocol: "Digital Signage Sync", floorAction: "Confirm correct lobby content and bell-times.", priority: "Low", riskLevel: "Low", consequence: "Outdated campus info.", proof: "Visual Check", cadence: "daily" },
                ...
                { id: "S-IT-10", technicalProtocol: "EOD Hardware Shutdown", floorAction: "Verify power-off for all non-essential projection tech.", priority: "Low", riskLevel: "Low", consequence: "Energy waste and bulb life decay.", proof: "Signed Sheet", cadence: "daily" }
            ]
        },
        {
            ...
            icon: "test-tube",
            tasks: [
                { id: "S-LAB-01", technicalProtocol: "Chemical Storage Seal", floorAction: "Verify Acid/Base segregation in locked cabinets.", priority: "High", riskLevel: "High", consequence: "Toxic gas release / Explosion hazard.", proof: "Visual Check", verificationRequired: true, cadence: "daily" },
                { id: "S-LAB-02", technicalProtocol: "Eye-wash Station Test", floorAction: "Run 10s flush; verify clear water flow.", priority: "High", riskLevel: "High", consequence: "Permanent chemical eye damage.", proof: "Test Log", verificationRequired: true, cadence: "daily" },
                ...
                { id: "S-LAB-04", technicalProtocol: "PPE Availability Pulse", floorAction: "Confirm 50 pairs of nitrile gloves in junior lab.", priority: "Medium", riskLevel: "Low", consequence: "Student skin exposure.", proof: "Visual Count", cadence: "daily" },
                { id: "S-LAB-05", technicalProtocol: "Experiment Pre-auth", floorAction: "Verify safety map and disposal plan for today's Grade 12 lab.", priority: "High", riskLevel: "High", consequence: "Uncontrolled chemical reaction.", proof: "Permit Note", verificationRequired: true, cadence: "daily" },
                { id: "S-LAB-06", technicalProtocol: "Lab Gas-Bank Shutdown", floorAction: "Physically witness lock of main Bunsen gas valves.", priority: "High", riskLevel: "High", consequence: "Overnight campus fire.", proof: "Closure Log", verificationRequired: true, cadence: "daily" },
                { id: "S-LAB-07", technicalProtocol: "Specimen Disposal Log", floorAction: "Confirm 100% autoclaving of bio-hazard waste.", priority: "High", riskLevel: "Medium", consequence: "Pathogen spread in trash.", proof: "Disposal Note", cadence: "weekly" },
                ...
                { id: "S-LAB-09", technicalProtocol: "Sharp Tool Audit", floorAction: "Verify 100% count of scalpels in the biology store.", priority: "High", riskLevel: "Medium", consequence: "Weaponization/Injury risk.", proof: "Stock Sheet", verificationRequired: true, cadence: "daily" },
        ...
        },
        {
            ...
            icon: "megaphone",
            tasks: [
                { id: "S-PR-01", technicalProtocol: "Enquiry Triage TAT", floorAction: "Reply to 100% of new admission leads < 2 hours.", priority: "Medium", riskLevel: "Low", consequence: "Lost revenue / conversion drop.", proof: "CRM Dashboard", cadence: "daily" },
                { id: "S-PR-02", technicalProtocol: "Parent Issue Loop", floorAction: "Resolve all billing/admin complaints < 24h.", priority: "High", riskLevel: "Low", consequence: "Escalated viral PR damage.", proof: "Incident Log", cadence: "daily" },
                { id: "S-PR-03", technicalProtocol: "Lobby Ambiance Pulse", floorAction: "Verify air-freshener and lighting pre-opening.", priority: "Low", riskLevel: "Low", consequence: "Poor brand first-impression.", proof: "Visual Check", cadence: "daily" },
                ...
                { id: "S-PR-07", technicalProtocol: "School App Broadcast", floorAction: "Verify 100% success of morning 'Bell-Update' signal.", priority: "Low", riskLevel: "Low", consequence: "Parental communication gap.", proof: "System Screen", cadence: "daily" },
                ...
                { id: "S-PR-10", technicalProtocol: "EOD Enquiry Reconcile", floorAction: "Final count of walk-ins vs conversions.", priority: "Medium", riskLevel: "Low", consequence: "Zero marketing ROI intel.", proof: "Signed Sheet", cadence: "daily" }
            ]
        },
        {
            ...
            icon: "user-plus",
            tasks: [
                { id: "S-ADM-01", technicalProtocol: "KYC Document Vetting", floorAction: "Verify 100% original birth-certs for new enrollments.", priority: "High", riskLevel: "High", consequence: "Regulatory board audit failure.", proof: "Registry Audit", verificationRequired: true, cadence: "daily" },
                { id: "S-ADM-02", technicalProtocol: "Fee Clearance Seal", floorAction: "Verify 100% payment receipt before issuing Hall Tickets.", priority: "High", riskLevel: "Medium", consequence: "Unrecoverable revenue bad-debt.", proof: "Finance Sync", verificationRequired: true, cadence: "daily" },
                { id: "S-ADM-03", technicalProtocol: "Waitlist Integrity", floorAction: "Cross-check 10 entries for first-come-first-serve parity.", priority: "Medium", riskLevel: "Low", consequence: "Favoritism claims and legal threats.", proof: "Audit Report", cadence: "weekly" },
                ...
                { id: "S-ADM-05", technicalProtocol: "Scholarship Vetting", floorAction: "Audit proof of income for 100% of tuition-waiver cases.", priority: "High", riskLevel: "Medium", consequence: "Revenue leakage via fraud.", proof: "Signed Form", verificationRequired: true, cadence: "monthly" },
                ...
                { id: "S-ADM-07", technicalProtocol: "Sibling Preference", floorAction: "Verify 100% mapping of sibling pairs for route optimization.", priority: "Low", riskLevel: "Low", consequence: "Operational inefficiency.", proof: "Sample Check", cadence: "weekly" },
                { id: "S-ADM-08", technicalProtocol: "Fee Journal Seriality", floorAction: "Confirm zero gaps in digital receipt sequence.", priority: "High", riskLevel: "High", consequence: "Financial manipulation / embezzlement.", proof: "Journal Audit", verificationRequired: true, cadence: "daily" },
        ...
        },
        {
            ...
            icon: "sparkles",
            tasks: [
                { id: "S-HYG-01", technicalProtocol: "Washroom Odor Pulse", floorAction: "Audit 30-min cleaning log for junior-wing restrooms.", priority: "High", riskLevel: "Low", consequence: "Primary driver of parent complaints.", proof: "Hourly Sheet", cadence: "hourly" },
                ...
                { id: "S-HYG-04", technicalProtocol: "Drinking Water Hygiene", floorAction: "Inspect cooler spouts for zero mold/scale buildup.", priority: "High", riskLevel: "High", consequence: "Water-borne disease outbreak.", proof: "Visual Audit", verificationRequired: true, cadence: "daily" },
                { id: "S-HYG-05", technicalProtocol: "Spill Response TAT", floorAction: "Execute 2-min cleanup for all detected FOH spills.", priority: "High", riskLevel: "High", consequence: "Student slip/fall injury.", proof: "Incident Log", verificationRequired: true, cadence: "incident-based" },
                { id: "S-HYG-06", technicalProtocol: "Chemical Dilution Ratio", floorAction: "Audit dispenser flow-rates for floor sanitizers.", priority: "High", riskLevel: "Medium", consequence: "Chemical burns or ineffective cleaning.", proof: "Titration Check", cadence: "weekly" },
        ...
        },
        {
            ...
            tasks: [
                ...
                { id: "S-SEC-04", technicalProtocol: "Patrol Frequency Scan", floorAction: "Verify guard tour tags match the boundary patrol roster.", priority: "Medium", riskLevel: "Low", consequence: "Gaps in physical security.", proof: "NFC Log", cadence: "daily" },
                ...
                { id: "S-SEC-09", technicalProtocol: "Entrance Flow Guard", floorAction: "Clear all illegally parked private vehicles from bus lane.", priority: "High", riskLevel: "High", consequence: "Delayed arrival/exit and safety risk.", proof: "Patrol Log", cadence: "hourly" },
        ...
        },
        {
            ...
            tasks: [
                ...
                { id: "S-CAN-05", technicalProtocol: "Staff Health Vetting", floorAction: "Verify zero open wounds/fever for cafeteria servers.", priority: "High", riskLevel: "High", consequence: "Pathogen transmission to students.", proof: "Daily Audit", verificationRequired: true, cadence: "daily" },
                ...
                { id: "S-CAN-09", technicalProtocol: "Supplier FSSAI Audit", floorAction: "Verify validity of fresh meat/dairy vendor license.", priority: "Medium", riskLevel: "High", consequence: "Illegal/Unsafe sourcing liability.", proof: "License Registry", cadence: "weekly" },
        ...
        },
        {
            ...
            icon: "volleyball",
            tasks: [
                { id: "S-SPT-01", technicalProtocol: "Equipment Safety Scan", floorAction: "Inspect posts, nets, and gymnastics mats for tears/cracks.", priority: "High", riskLevel: "High", consequence: "Catastrophic student injury during PE.", proof: "Safety Log", verificationRequired: true, cadence: "daily" },
                ...
                { id: "S-SPT-08", technicalProtocol: "Sports Lighting Test", floorAction: "Verify 100% illumination of pitch floodlights (Target 500 lux).", priority: "Low", riskLevel: "Low", consequence: "Collision risk during sunset practice.", proof: "Meter Reading", cadence: "daily" },
                { id: "S-SPT-09", technicalProtocol: "Staff Sobriety Pulse", floorAction: "Verify zero impairment for 100% of coaching staff.", priority: "High", riskLevel: "High", consequence: "Safety breach in aquatic/sports zones.", proof: "Briefing Log", verificationRequired: true, cadence: "daily" },
        ...
        },
        {
            ...
            tasks: [
                ...
                { id: "S-ESG-03", technicalProtocol: "Water Leakage Patrol", floorAction: "Check 3 AM meter for zero-usage baseline.", priority: "High", riskLevel: "Medium", consequence: "Structural damage and resource waste.", proof: "Leak Log", verificationRequired: true, cadence: "daily" },
        ...
        },
        {
            ...
            icon: "wrench",
            tasks: [
                { id: "S-MNT-01", technicalProtocol: "Electrical Panel IR", floorAction: "Perform heat scan of main distribution bank.", priority: "High", riskLevel: "High", consequence: "Overnight short-circuit fire.", proof: "Scan Log", verificationRequired: true, cadence: "weekly" },
                { id: "S-MNT-02", technicalProtocol: "Potable Water TDS", floorAction: "Log purity at 3 student drinking points.", priority: "High", riskLevel: "High", consequence: "Water-borne disease outbreak.", proof: "TDS Reading", verificationRequired: true, cadence: "daily" },
                ...
                { id: "S-MNT-07", technicalProtocol: "LOTO Enforcement", floorAction: "Confirm 100% of MEP repairs possess lock-out tags.", priority: "High", riskLevel: "High", consequence: "Fatal maintenance injury.", proof: "Visual Audit", verificationRequired: true, cadence: "daily" },
