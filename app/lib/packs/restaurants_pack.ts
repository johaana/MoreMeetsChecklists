...
export const restaurants: PremiumPack = {
    ...
    checklists: [
        ...
        },
        {
            ...
            icon: "sunrise",
            tasks: [
                { id: "RES-KIT-01", description: "Check Fridge Temps: Make sure walk-in fridges are between 1°C and 4°C.", priority: "High", riskLevel: "High", consequence: "Food spoils and causes food poisoning.", proof: "Temp Log", trainerNotes: "Check at 8 AM and 8 PM daily." },
                { id: "RES-KIT-02", description: "Clean Surfaces: Use a test strip to check if the cleaning spray is strong enough (Aim for 200ppm).", priority: "High", riskLevel: "Medium", consequence: "Bacteria spreads between different foods.", proof: "Test Strip", trainerNotes: "Change cleaning water every 2 hours." },
                { id: "RES-KIT-03", description: "Check Food Dates: Make sure all prep has a date label and old food is used first.", priority: "High", riskLevel: "High", consequence: "Serving expired food to customers.", proof: "Visual Note", trainerNotes: "Throw away any labels you can't read." },
                ...
                { id: "RES-KIT-06", description: "Check Dishwasher Heat: Make sure the final rinse water reaches 82°C.", priority: "High", riskLevel: "High", consequence: "Germs stay on plates and glasses.", proof: "Dish Log", trainerNotes: "Rinse must hit 82°C to sanitize." },
                { id: "RES-KIT-07", description: "Staff Hygiene Check: Make sure everyone has clean nails and a hairnet on.", priority: "High", riskLevel: "Medium", consequence: "Hair or dirt falling into the food.", proof: "Briefing Log", trainerNotes: "Wash hands every time you enter the kitchen." },
        ...
        },
        {
            ...
            tasks: [
                ...
                { id: "RES-FIN-09", description: "Check Open Bills: See if any tables have been open too long.", priority: "High", riskLevel: "Medium", consequence: "Staff 'parking' bills to hide stolen cash.", proof: "Open Bill Log", trainerNotes: "Tables open for more than 3 hours is a red alert." },
