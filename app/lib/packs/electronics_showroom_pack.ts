    ...
    checklists: [
        ...
        },
        {
            ...
            tasks: [
                ...
                { id: "E-CSH-09", technicalProtocol: "POS Cleanliness", floorAction: "Sanitize screen and high-touch areas twice daily.", priority: "Low", riskLevel: "Medium", consequence: "Disease spread among staff.", proof: "Cleaning Note", cadence: "daily" },
        ...
        },
        {
            ...
            tasks: [
                ...
                { id: "E-LPO-04", technicalProtocol: "Staff Exit Search", floorAction: "Perform random check of 3 staff bags at EOD.", priority: "Medium", riskLevel: "Medium", consequence: "Internal shrinkage window.", proof: "Registry Note", cadence: "daily" },
