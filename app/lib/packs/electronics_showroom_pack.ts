...
export const electronics_showroom_pack: PremiumPack = {
    ...
    checklists: [
        ...
        },
        {
            ...
            icon: "barcode",
            tasks: [
                { id: "ASSET-01", description: "Record the unique serial number of every item at goods receipt.", priority: "High", riskLevel: "High", consequence: "Without serial numbers, it is impossible to track individual units, making theft easy to conceal.", proof: "GRN Serial Log" },
