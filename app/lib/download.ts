...
/**
 * Sovereign Engine v8.5 - INSTITUTIONAL FINAL
...
export const handleDownload = (item: PremiumPack | IndividualChecklist, type: 'pack' | 'individual') => {
    ...
    const ORDER_ID = "MM-MASTER-SOVEREIGN-8.5";
    ...
    const homeData: any[][] = [
        ...
        [null, { v: `Institutional Operating System v8.5 | Sovereign Master Build`, s: { fill: { patternType: 'solid', fgColor: { rgb: COLORS.NAVY_DEEP } }, alignment: { horizontal: 'center', ...verticalCenter }, font: { italic: true, bold: true, sz: 12, color: { rgb: COLORS.PRIMARY_GREEN } } } }],
    ...
    writeFile(wb, `${item.title.replace(/ /g, '_')}_Sovereign_8.5.xlsx`);
}
