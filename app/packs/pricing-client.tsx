                    ...
                    <div className="max-w-xl mx-auto">
                        <div className="bg-black border border-white/10 shadow-[0_40px_100px_-15px_rgba(0,0,0,0.5)] rounded-[2rem] md:rounded-[2.5rem] overflow-hidden text-center">
                            <div className="bg-white/[0.01] p-8 md:p-12 space-y-6">
                                ...
                                <p className="text-5xl md:text-6xl font-black pt-2 md:pt-4" style={{ color: BRAND_GREEN }}>FREE</p>
                            </div>
    ...
    return (
        <section className="w-full py-12 md:py-20 bg-gradient-to-b from-[#0B0F14] to-[#0E1621] text-white overflow-hidden border-t border-white/5" id="pricing">
            <div className="container px-4 mx-auto max-w-5xl">
                <div className="grid lg:grid-cols-[1fr,400px] gap-10 md:gap-12 items-center">
                    ...
                    <div className="space-y-8 md:space-y-10">
                        <div className="space-y-3 md:space-y-4">
                            ...
                            <h2 className="text-3xl md:text-5xl font-black font-headline text-white italic tracking-tighter uppercase leading-tight">
                                Sovereign <br />
                        ...
                        <div className="flex items-center gap-4 md:gap-6">
                            <div className="flex flex-col">
                                <span className="text-base md:text-lg font-medium text-zinc-500 line-through italic tracking-tight leading-none">
                                    {region === 'INDIA' ? `₹${pack.anchorPriceINR}` : `$${pack.anchorPriceUSD}`}
                                </span>
                                <h3 className="text-5xl md:text-6xl font-black text-white italic tracking-tighter leading-none pt-2" style={{ textShadow: `0 0 20px ${BRAND_GREEN}30` }}>
                                    {region === 'INDIA' ? `₹${pack.priceINR}` : `$${pack.priceUSD}`}
                                </h3>
                            </div>
                            <div className="w-px h-12 md:h-16 bg-white/10 hidden sm:block" />
                            <div className="space-y-1">
                                <p className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.15em] md:tracking-[0.2em]" style={{ color: CONVERSION_AMBER }}>LIMITED TIME OFFER</p>
                                <p className="text-[10px] md:text-[11px] font-bold text-zinc-500 uppercase tracking-widest italic">One-time payment • Own forever</p>
                            </div>
                        </div>

                        <div className="grid sm:grid-cols-2 gap-x-6 md:gap-x-8 gap-y-4 md:gap-y-5">
                            {VALUE_ITEMS.map((item, i) => (
                                <div key={i} className="flex items-start gap-3 group">
                                    <div className="w-4 h-4 md:w-5 md:h-5 rounded-full flex items-center justify-center shrink-0 mt-1 md:mt-0.5" style={{ backgroundColor: `${BRAND_GREEN}1A` }}>
                                        <item.i className="w-2.5 h-2.5 md:w-3 md:h-3" style={{ color: BRAND_GREEN }} />
                                    </div>
                                    <span className="text-xs md:text-sm font-bold italic text-zinc-300 group-hover:text-white transition-colors leading-tight">
                                        {item.t}
                                    </span>
                                </div>
                            ))}
                    ...
                    <div className="relative pt-4 lg:pt-0">
                        <div className="absolute -inset-4 blur-3xl opacity-40 md:opacity-50" style={{ backgroundColor: `${BRAND_GREEN}0D` }} />
                        ...
                        <div className="relative bg-white/[0.02] border border-white/[0.08] backdrop-blur-xl rounded-[1.5rem] md:rounded-[2.5rem] p-6 md:p-10 shadow-2xl flex flex-col items-center gap-6 md:gap-8">
                            ...
                            <div className="text-center space-y-4 w-full">
                                <div className="space-y-1.5">
                                    <p className="text-[9px] md:text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em] md:tracking-[0.3em]">SELECT REGION</p>
                                ...
                                <div className="pt-2">
                                    <p className="text-xs md:text-sm font-medium text-zinc-400 italic">Start using your system today</p>
                                    <p className="text-2xl md:text-3xl font-black text-white italic tracking-tighter pt-1">
                                        {region === 'INDIA' ? `₹${pack.priceINR}` : `$${pack.priceUSD}`}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="w-full flex flex-col items-center gap-4 md:gap-5">
                                ...
                                <div className="space-y-2">
                                    {[
                                        ...
                                        <div key={i} className="flex items-center gap-2 text-[9px] md:text-[10px] font-bold text-zinc-500 italic">
                                            <CheckCircle2 className="w-2.5 h-2.5 md:w-3 md:h-3" style={{ color: `${BRAND_GREEN}99` }} /> {line}
                                        </div>
                                    ))}
                                </div>
                            </div>
                ...
                <div className="mt-12 md:mt-16 pt-6 md:pt-8 text-center border-t border-white/5">
