...
function FreeDownloadForm({ pack }: { pack: PremiumPack }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            />
            <Button size="lg" type="submit" className="w-full font-black uppercase italic tracking-[0.2em] text-xs h-12" disabled={loading} variant="accent">
             ...
             <section className="w-full py-12 md:py-16" id="pricing">
                <div className="container px-2 md:px-6">
                    <div className="max-w-3xl mx-auto mb-10 text-center space-y-4">
                        <Badge variant="outline" className="text-primary border-primary/30 uppercase tracking-[0.5em] font-black text-[11px]">Social Impact Deployment</Badge>
                    ...
                    <div className="flex justify-center">
                        <Card className="flex flex-col max-w-md w-full bg-black border-white/10 shadow-2xl rounded-2xl overflow-hidden">
                            ...
                            <CardFooter className="mt-auto flex flex-col justify-center w-full gap-4 p-8 pt-0">
                                ...
                                <p className="text-[10px] text-white/20 text-center uppercase tracking-[0.4em] font-black">PRO BONO PUBLICO LICENSE</p>
                            </CardFooter>
                        </Card>
                    </div>
                </div>
