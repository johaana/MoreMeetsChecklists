...
const StickyCta = ({ price = "₹999" }: { price?: string }) => {
    ...
    return (
        <div className={cn(
            ...
            <Button asChild size="lg" className="w-full rounded-full shadow-2xl bg-primary text-black font-black uppercase italic text-[11px] tracking-[0.2em] px-8 h-14 border-none hover:scale-105 active:scale-95">
...
const CtaBlock = ({ price = "₹999", sub = "INSTITUTIONAL ACCESS • OWN FOREVER" }: { price?: string, sub?: string }) => (
    <div className="flex flex-col items-center gap-4 py-8">
        ...
        <div className="space-y-1">
            <p className="text-[11px] font-black text-primary uppercase tracking-[0.3em] text-center">{price} / $12 — ONE-TIME DEPLOYMENT</p>
...
export default function PackClientPage({ pack }: { pack: PremiumPack }) {
  const isRestaurant = pack.id === 'restaurants';
  const totalChecklists = isRestaurant ? 12 : (pack.checklists?.length || 0);
  const totalTasks = isRestaurant ? 120 : (pack.checklists?.reduce((sum, checklist) => sum + (checklist.tasks?.length || 0), 0) || 0);
  const roles = isRestaurant ? 12 : Array.from(new Set(pack.checklists?.map(c => c.role) || [])).length;
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-1">
        ...
        <section className="relative w-full pt-12 pb-16 md:pt-24 md:pb-24 bg-secondary/30 border-b border-white/5">
          <div className="container px-4 md:px-6 text-center max-w-5xl mx-auto space-y-10">
            ...
            <div className="pt-4 space-y-8">
                <div className="flex flex-wrap justify-center gap-4 text-[11px] font-black text-white/40 uppercase tracking-[0.3em]">
                    <span>{totalChecklists} MODULES</span>
                    <span className="text-primary/40">•</span>
                    <span>{totalTasks}+ CONTROL POINTS</span>
                    <span className="text-primary/40">•</span>
                    <span>{roles}-ROLE SYSTEM</span>
                </div>
        ...
        <Section className="bg-black border-b border-white/5">
            <div className="max-w-5xl mx-auto space-y-16">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-6 p-10 rounded-[2.5rem] bg-red-500/[0.02] border border-red-500/10 shadow-2xl">
                    ...
                    <div className="space-y-6 p-10 rounded-[2.5rem] bg-white/[0.02] border border-white/10 shadow-2xl">
        ...
        <Section className="bg-alternate-background">
            <div className="max-w-5xl mx-auto text-center space-y-16">
                ...
                <div className="space-y-4 pt-12">
                    ...
                    <p className="text-4xl md:text-7xl font-black text-primary uppercase italic tracking-tighter leading-none uppercase">THIS IS YOUR CONTROL SYSTEM.</p>
                </div>
            </div>
        </Section>
            ...
            <div className="max-w-6xl mx-auto space-y-20">
                ...
                <div className="grid md:grid-cols-5 gap-8">
                    {[
                        ...
                        { t: "THEY EXECUTE", d: "Type name → task turns green. No guessing.", i: Target },
                        { t: "AUTO SCHEDULING", d: "Daily, Weekly, Monthly cycles run automatically.", i: Clock },
            ...
            <div className="max-w-5xl mx-auto space-y-16">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        { t: "HOW TO DO IT", d: "Trainer Notes in simple language. No training curve required.", i: GraduationCap },
                ...
                <div className="text-center pt-8 space-y-4">
                    ...
                    <p className="text-sm font-bold text-white/20 uppercase tracking-[0.3em]">No misinterpretation • Faster onboarding • No dependency</p>
                </div>
            </div>
        </Section>
        ...
        <Section className="bg-black">
            <div className="max-w-6xl mx-auto space-y-16">
                <div className="text-center space-y-4">
                    ...
                    <SectionHeadline>WHY THIS IS DIFFERENT</SectionHeadline>
                </div>
