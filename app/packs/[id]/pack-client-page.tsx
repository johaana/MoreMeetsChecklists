  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-1">
        ...
        <section className="relative w-full pt-12 pb-12 md:pt-24 md:pb-24 bg-secondary/30 border-b border-white/5">
          <div className="container px-4 md:px-6 text-center max-w-5xl mx-auto space-y-12">
            <div className="space-y-6">
                <Badge variant="outline" className="text-primary border-primary/30 py-1.5 px-4 uppercase tracking-[0.3em] font-black text-[10px] bg-primary/5">
                    {pack.category} • MoreMeets™ Sovereign v11.9
                </Badge>
                <h1 className="text-4xl md:text-7xl lg:text-8xl font-black tracking-tighter font-headline text-primary-text uppercase italic leading-[0.95]">
                ...
                <p className="max-w-[750px] mx-auto text-secondary-text text-lg md:text-xl font-medium leading-relaxed italic border-l-2 border-primary/20 pl-6">
                    {pack.heroHeadline || "Standardize your kitchen. Protect your margins."} <br />
            ...
            <div className="pt-4">
                <h3 className="text-[11px] font-black text-white/20 uppercase tracking-[0.4em] mb-6">BUILT FOR INSTITUTIONAL COMMAND:</h3>
                <div className="flex flex-wrap justify-center gap-2 md:gap-4">
                    {pack.whoIsItFor?.map(role => (
                        <div key={role} className="px-4 py-2 rounded-lg bg-white/[0.03] border border-white/5 text-[10px] font-black uppercase text-secondary-text tracking-widest italic">
                            {role}
                        </div>
                    ))}
                </div>
        ...
        <Section className="bg-black border-b border-white/5">
            <div className="max-w-5xl mx-auto space-y-16">
                <div className="text-center space-y-4">
                    <Badge variant="outline" className="text-red-500 border-red-500/30 uppercase tracking-[0.3em] font-black text-[10px]">Forensic Reality Check</Badge>
                    <SectionHeadline>WHY {pack.category.toUpperCase()} BREAKS</SectionHeadline>
                </div>

                <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-6 p-10 rounded-[2.5rem] bg-red-500/[0.02] border border-red-500/10">
                        <h3 className="text-red-500/60 font-black uppercase tracking-widest text-xs italic">THE CORE PROBLEM</h3>
                        <div className="space-y-5">
                            {[
                                "Tasks depend on human memory",
                                "SOPs sit in folders, ignored",
                                "Managers spend 40% of time following up",
                                "Staff executes differently every shift",
                                "Zero real-time executive visibility"
                            ].map(item => (
                    ...
                    <div className="space-y-6 p-10 rounded-[2.5rem] bg-white/[0.02] border border-white/10">
                        <h3 className="text-white/40 font-black uppercase tracking-widest text-xs italic">THE EXPOSURE</h3>
                        <div className="space-y-5">
                            {[
                                "Critical food safety / legal risks",
                                "Unmonitored profit leakage and theft",
                                "Brand damage via negative reviews",
                                "Total dependency on individual heroes",
                                "Systemic operational chaos"
                            ].map(item => (
                                <div key={item} className="flex items-start gap-4 text-base text-zinc-400 italic font-medium leading-tight">
                ...
                <div className="text-center pt-8">
                    <p className="text-2xl md:text-3xl font-black text-primary-text uppercase italic tracking-tighter leading-none">THIS IS NOT A PEOPLE PROBLEM.</p>
                    <p className="text-4xl md:text-6xl font-black text-red-500 uppercase italic tracking-tighter">THIS IS A SYSTEM PROBLEM.</p>
                </div>
            </div>
        </Section>
        ...
        <Section className="bg-alternate-background">
            <div className="max-w-5xl mx-auto text-center space-y-16">
                ...
                <div className="flex flex-wrap justify-center gap-x-8 md:gap-x-16 gap-y-10">
                    {[
                        ...
                        <div key={i} className="flex items-center gap-4 md:gap-6">
                            <span className="text-lg md:text-2xl font-black text-white/20 uppercase tracking-widest italic">{shift.from}</span>
                            <ArrowRight className="w-5 h-5 text-primary/40" />
                            <span className="text-lg md:text-2xl font-black text-primary uppercase tracking-widest italic">{shift.to}</span>
                        </div>
                    ))}
                </div>
                ...
                <div className="space-y-4 pt-12">
                    ...
                    <p className="text-4xl md:text-7xl font-black text-primary uppercase italic tracking-tighter leading-none">THIS IS YOUR CONTROL SYSTEM.</p>
                </div>
            </div>
        </Section>
            ...
            <div className="max-w-6xl mx-auto space-y-20">
                ...
                <div className="grid md:grid-cols-5 gap-8">
                    {[
                        ...
                        { t: "TEAM OPENS TASKS", d: "They instantly see what to do, how, and why it matters.", i: Smartphone },
                        { t: "THEY EXECUTE", d: "Names entered → task turns green instantly. No guessing.", i: Target },
                        { t: "AUTO SCHEDULING", d: "Daily, Weekly, Monthly cycles run independently.", i: Clock },
                        { t: "YOU SEE EVERYTHING", d: "Open dashboard to see reality live. No follow-ups.", i: Activity }
                    ].map((step, i) => (
        ...
        <Section className="bg-alternate-background overflow-hidden border-y border-white/5">
            <div className="max-w-6xl mx-auto space-y-16">
                ...
                <div className="relative rounded-[2.5rem] border border-white/10 bg-zinc-900/50 p-2 shadow-2xl group">
                ...
                <div className="text-center space-y-4 pt-8">
                    <p className="text-2xl md:text-5xl font-black text-primary-text uppercase italic tracking-tighter">YOU DON'T ASK. <br /><span className="text-primary">YOU ALREADY KNOW.</span></p>
                </div>
            </div>
        </Section>
        ...
        <Section className="bg-black">
            <div className="max-w-5xl mx-auto space-y-16">
                <div className="text-center space-y-4">
                    <Badge variant="outline" className="text-primary border-primary/30 uppercase tracking-[0.3em] font-black text-[11px]">Sovereign Design</Badge>
                    <SectionHeadline>EVERY TASK IS BUILT FOR EXECUTION</SectionHeadline>
                </div>

                <div className="grid md:grid-cols-3 gap-8">
                    {[
                        { t: "WHAT TO DO", d: "Clear, technical instruction. No ambiguity. No guessing.", i: ClipboardCheck },
                        { t: "HOW TO DO IT", d: "Trainer Notes in plain language. Zero training curve required.", i: GraduationCap },
                        { t: "WHY IT MATTERS", d: "Specific consequences of failure defined to drive staff seriousness.", i: AlertTriangle }
                    ].map((item, i) => (
                        <div key={i} className="p-10 rounded-[2rem] bg-white/[0.02] border border-white/5 space-y-6 hover:border-primary/20 transition-all group">
        ...
        <Section className="bg-alternate-background">
            <div className="max-w-6xl mx-auto space-y-16">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        { cat: pack.category.toUpperCase(), title: "Cold-Chain Check", d: "Fridge 1°C–4°C verified → prevents food poisoning" },
        ...
        <Section className="bg-black">
            <div className="max-w-6xl mx-auto space-y-16">
                <div className="text-center space-y-4">
                    <Badge variant="outline" className="text-accent border-accent/30 uppercase tracking-[0.3em] font-black text-[11px]">Category Differentiator</Badge>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        { t: "SHIFT PARITY", d: "Morning = Night = Same standard across every outlet.", i: Repeat },
                        { t: "AGGREGATOR SHIELD", d: "Organization reduces cancellations and bad ratings.", i: BarChart3 }
                    ].map((item, i) => (
                        <div key={i} className="p-8 rounded-3xl border border-white/5 bg-white/[0.02] flex flex-col items-center text-center gap-4 hover:border-primary/30 transition-all">
                            ...
                            <p className="text-xs text-secondary-text italic font-medium leading-relaxed">{item.d}</p>
                        </div>
                    ))}
                </div>
        ...
        <Section className="bg-alternate-background">
            <div className="max-w-5xl mx-auto space-y-16">
                <div className="grid md:grid-cols-2 gap-12 relative">
                    ...
                    <div className="space-y-8 p-12 rounded-[3rem] bg-red-500/[0.02] border border-red-500/10">
                    ...
                    <div className="space-y-8 p-12 rounded-[3rem] bg-primary/[0.02] border border-primary/10">
                ...
                <div className="text-center">
                    <p className="text-4xl md:text-6xl font-black text-primary-text uppercase italic tracking-tighter">FROM FIRE-FIGHTING → COMMAND</p>
                </div>
            </div>
        </Section>
        ...
        <Section className="bg-black">
            <div className="max-w-5xl mx-auto space-y-16">
                ...
                <div className="text-center space-y-4 pt-12">
                    <p className="text-xl md:text-3xl font-black text-primary-text uppercase italic tracking-tighter leading-none">READY TO DEPLOY IN 10 MINUTES.</p>
