                ...
                <div className="flex flex-col items-center md:items-start gap-2">
                    <Link href="/" className="flex items-center justify-center gap-2" prefetch={false}>
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-[8px] font-black uppercase tracking-[0.2em] text-zinc-400 leading-none mt-1">Operational Infrastructure</span>
                        </div>
                    </Link>
                    ...
                    <div className="pt-6 hidden md:block">
                        <p className="text-[9px] font-black uppercase tracking-widest text-zinc-300">Operational Manifesto:</p>
                        <p className="text-[10px] italic font-medium text-zinc-400 mt-1">Systems serve people. People run systems. Luck is not a strategy.</p>
                    </div>
                </div>
