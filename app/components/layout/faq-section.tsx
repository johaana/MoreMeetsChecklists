                ...
                <Accordion type="single" collapsible className="w-full" defaultValue="item-1">
                    <AccordionItem value="item-1" className="border-white/10">
                        ...
                        <AccordionContent className="text-secondary-text leading-relaxed font-medium italic space-y-4">
                           ...
                           <p>SOPs sit in folders. They depend on memory. They are not visible or followed daily.</p>
                           <p>MoreMeets turns SOPs into a <strong>Live Operating System.</strong> Tasks are structured, responsibility is assigned, and execution is recorded in real time. You see everything live.</p>
                    ...
                    <AccordionItem value="item-2" className="border-white/10">
                        ...
                        <AccordionContent className="text-secondary-text leading-relaxed font-medium italic space-y-4">
                          <p>It runs on <strong>Excel / Google Sheets</strong>—tools your team already understands. No new software to install, no learning curve, and no user accounts to manage.</p>
                          <p>Because there's no technical friction, adoption is instant. Your team enters their name when a task is done, and the dashboard updates automatically.</p>
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-3" className="border-white/10">
                        ...
                        <AccordionContent className="text-secondary-text leading-relaxed font-medium italic">
                           Yes, because it’s <strong>Simple.</strong> They don't have to think or report separately. They simply open their role-specific view, see exactly what needs to be done, and enter their name when it's completed. It turns mechanical ticking into intentional discipline.
                        </AccordionContent>
                    </AccordionItem>

                    <AccordionItem value="item-4" className="border-white/10">
                        <AccordionTrigger className="text-primary-text font-bold hover:no-underline uppercase tracking-tighter italic text-left">What happens when a manager leaves?</AccordionTrigger>
                        <AccordionContent className="text-secondary-text leading-relaxed font-medium italic">
