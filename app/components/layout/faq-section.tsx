                ...
                <Accordion type="single" collapsible className="w-full" defaultValue="item-1">
                    ...
                    <AccordionItem value="item-2" className="border-white/10">
                        ...
                        <AccordionContent className="text-secondary-text leading-relaxed font-medium italic space-y-4">
                           ...
                           <p>SOPs sit in folders. They depend on memory. They are not followed daily. MoreMeets turns SOPs into a <strong>Live Operating System</strong> where responsibility is assigned and execution is recorded in real time.</p>
