                ...
                <Accordion type="single" collapsible className="w-full" defaultValue="item-1">
                    <AccordionItem value="item-1" className="border-white/10">
                        ...
                        <AccordionContent className="text-secondary-text leading-relaxed font-medium italic space-y-4">
                           <p>MoreMeets™ is a <strong>pre-built operational system</strong>. It combines structured SOPs, live execution tracking, and a real-time dashboard into one engine.</p>
                           <p>Your team performs daily tasks, the system captures execution automatically, and you see everything live. Every task includes exactly <strong>What</strong> to do, <strong>How</strong> to do it (Trainer Notes), and <strong>Why</strong> it matters (Consequences of Failure).</p>
                           <p className="text-primary-text font-black border-t border-white/5 pt-2 italic uppercase">This is not a checklist. This is a system that runs your operations.</p>
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-2" className="border-white/10">
                        ...
                        <AccordionContent className="text-secondary-text leading-relaxed font-medium italic space-y-4">
                           ...
                           <p>Tasks are structured, responsibility is assigned by role, and execution is logged in real-time. Every task includes technical protocols and the gravity of failure.</p>
                    ...
                    <AccordionItem value="item-4" className="border-white/10">
                        ...
                        <AccordionContent className="text-secondary-text leading-relaxed font-medium italic space-y-4">
                          <p>You receive a complete, standalone operational engine pre-configured for your industry.</p>
                          <ul className="space-y-2">
                            <li className="flex items-start gap-2">
                                <div className="w-1 h-1 rounded-full bg-primary mt-2 shrink-0" />
                                <span>Pre-built daily, weekly, and monthly mission systems.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="w-1 h-1 rounded-full bg-primary mt-2 shrink-0" />
                                <span>8-Role Admin Matrix for instant task allocation.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="w-1 h-1 rounded-full bg-primary mt-2 shrink-0" />
                                <span>Live Executive Dashboard with multi-branch visibility.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="w-1 h-1 rounded-full bg-primary mt-2 shrink-0" />
                                <span>Audit-ready logs and forensically-vetted protocols.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <div className="w-1 h-1 rounded-full bg-primary mt-2 shrink-0" />
                                <span>Trainer Notes and Consequences for every task.</span>
                            </li>
                          </ul>
                          <p className="text-primary-text font-black border-t border-white/5 pt-2 italic uppercase">You don’t start from scratch. You start with a working system.</p>
                        </AccordionContent>
                    </AccordionItem>
