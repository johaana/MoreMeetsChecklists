            ...
            <div className="max-w-3xl mx-auto">
                <Accordion type="single" collapsible className="w-full" defaultValue="item-1">
                    <AccordionItem value="item-1">
                        ...
                        <AccordionContent>
                          Apps create <strong>"SaaS Friction."</strong> They require logins, long training curves, and monthly subscription bills. Excel is <strong>universally understood, 100% private, and works offline.</strong> It allows your team to start reporting in 2 minutes without a setup phase. Plus, you own the engine forever—no monthly fees to access your own data.
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2">
                        <AccordionTrigger>We already have SOPs. Why do we need MoreMeets?</AccordionTrigger>
                        <AccordionContent>
                           Most SOPs are "Dead Documents"—outdated, inconsistent, or not audit-ready. MoreMeets is not a document; it is a <strong>Live Operational Engine.</strong> It upgrades your existing knowledge into a structured, multi-branch framework that mandates daily discipline and provides instant executive visibility via telemetry.
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-4">
                     ...
                     <AccordionItem value="item-5">
                        <AccordionTrigger>Are these systems globally compliant and audit-ready?</AccordionTrigger>
                        <AccordionContent>
