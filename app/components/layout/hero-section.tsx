        ...
        <div className="container px-4 md:px-6 relative z-20 flex-1 flex flex-col justify-center py-8 md:py-0">
            <div className="max-w-2xl space-y-4 md:space-y-6">
                ...
                <div className="py-1 border-y border-red-500/40 w-fit inline-block md:border-none md:p-0">
                    <p className="text-[10px] md:text-base lg:text-lg font-black text-red-500 uppercase tracking-[0.15em] md:normal-case md:tracking-normal">
                        Consistency can’t depend on memory.
                    </p>
                </div>

                <p className="text-xs md:text-lg max-w-[520px] text-secondary-text leading-relaxed md:leading-[1.5] font-medium md:font-normal">
