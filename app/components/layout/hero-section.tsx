    ...
    <section className="relative w-full flex flex-col md:flex-row md:items-center md:h-screen md:min-h-[700px] overflow-hidden bg-background">
        ...
        <div className="container px-4 md:px-6 relative z-20 flex-1 flex flex-col justify-start md:justify-center py-6 md:py-0">
            <div className="max-w-2xl space-y-4 md:space-y-6">
                ...
                {/* Action Area: Recalibrated for Conversion */}
                <div className="flex flex-col items-start gap-4 pt-4 md:pt-8">
                    <div className="flex flex-col sm:flex-row items-center gap-6 w-full sm:w-auto">
                        <Button size="lg" asChild className="group w-full sm:w-auto h-14 rounded-xl shadow-xl md:shadow-2xl transition-all active:scale-95 px-8" style={{ backgroundColor: 'hsl(var(--authority-green))', color: 'hsl(var(--bg-primary))' }}>
                    ...
                    <p className="text-[11px] text-muted-foreground/60 font-normal pl-1">
