        ...
        {payload.map((item) => {
          ...
          return (
            <div
              key={item.value}
              className={cn(
                "flex items-center gap-1.5 [&>svg]:h-3 [&>svg]:size-3 [&>svg]:text-muted-foreground"
              )}
            >
              {Icon && !hideIcon ? (
                <Icon
          ...
          {payload.map((item, index) => {
            ...
            return (
              <div
                key={item.dataKey}
                className={cn(
                  "flex w-full items-stretch gap-2 [&>svg]:h-2.5 [&>svg]:size-2.5 [&>svg]:text-muted-foreground",
