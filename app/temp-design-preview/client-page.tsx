...
import { ArrowRight, CheckCircle, ShieldCheck, Zap, Frown, Smile, BrainCircuit, FileText, Users, Building, Factory, Popcorn, Hand, AlertTriangle, Check } from "lucide-react";
import { Card, CardHeader, CardTitle, CardContent, CardDescription, CardFooter } from '@/components/ui/card';
import { IconComponent } from '../components/icons';
import { motion } from 'framer-motion';

const HeroSection = () => (
    <section className="relative w-full h-[80vh] min-h-[600px] flex items-center text-white overflow-hidden">
        <video
    ...
    <section className="w-full py-16 md:py-24 bg-background">
        <div className="container px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
                <h2 className="text-3xl font-bold font-headline mb-4 text-primary">Most Operations Aren’t Broken. They’re Unprovable.</h2>
                ...
                <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-5xl mx-auto">
                    <div className="p-8 border-2 border-destructive/20 rounded-lg bg-card">
                        <CardHeader className="p-0 mb-4">
                            ...
                            <CardDescription>High Risk. Zero Proof.</CardDescription>
                        </CardHeader>
                    ...
                    <div className="p-8 border-2 border-primary/20 rounded-lg bg-card shadow-lg">
                        <CardHeader className="p-0 mb-4">
                            ...
                            <CardDescription>Low Risk. Verifiable System.</CardDescription>
                        </CardHeader>
                        <CardContent className="p-0 space-y-4">
    ...
    <section className="w-full py-16 md:py-24">
        <div className="container px-4 md:px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                {[
                    { icon: <BrainCircuit className="w-8 h-8" />, title: "Codified Expertise", description: "Knowledge doesn’t live in people—it lives in the standard." },
                    { icon: <FileText className="w-8 h-8" />, title: "Audit-Ready by Design", description: "Every task is structured to create a traceable, verifiable audit trail." },
                    { icon: <Zap className="w-8 h-8" />, title: "Offline & Owned", description: "Excel-based for universal access. No subscriptions, no vendor lock-in." },
                    { icon: <Users className="w-8 h-8" />, title: "People-Independent", description: "Train faster, scale safely, and reduce dependency on key individuals." }
                ].map((pillar, index) => (
                    <Card key={index} className="text-center p-6 bg-background hover:bg-secondary/50 transition-colors">
    ...
    <section className="w-full py-16 md:py-24 bg-secondary/30">
        <div className="container px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-12">
                ...
                <p className="text-lg text-muted-foreground mt-4">Select an industry-specific implementation of MoreMeets Standards™ to get started.</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                <Card className="flex flex-col">
                    ...
                    <CardContent className="flex-1 space-y-2 text-xs text-muted-foreground">
                        <p className="flex items-center gap-2"><Check className="w-4 h-4 text-green-500" /> Audit-ready framework</p>
                        <p className="flex items-center gap-2"><Check className="w-4 h-4 text-green-500" /> Offline Excel format</p>
                        <p className="flex items-center gap-2"><Check className="w-4 h-4 text-green-500" /> One-time purchase</p>
                    </CardContent>
                    <CardFooter>
                 ...
                 <Card className="flex flex-col">
                    <CardHeader>
                        ...
                        <CardTitle className="font-headline">Cinema & Multiplex Standard</CardTitle>
  ...
  <section className="w-full py-16 md:py-24">
    <div className="container px-4 md:px-6">
      <div className="text-center max-w-3xl mx-auto mb-12">
        ...
        <p className="text-lg text-muted-foreground mt-4">Control, ownership, and simplicity. No recurring costs, no vendor lock-in, no complex implementation.</p>
      </div>
