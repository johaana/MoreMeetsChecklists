...
/* --- RESOLUTION CTA 1: STRATEGIC SOLUTION (Focused on Tailoring) --- */
const Resolution_Strategic = () => (
    <div className="relative group w-full">
        ...
        <Card className="relative p-10 md:p-16 rounded-[2rem] border border-white/10 bg-black flex flex-col md:flex-row items-center gap-12 justify-between overflow-hidden shadow-2xl">
...
/* --- RESOLUTION CTA 2: INSTITUTIONAL PROTOCOL (Focused on Backbone) --- */
const Resolution_Protocol = () => (
    <div className="relative group w-full">
        ...
        <Card className="relative p-10 md:p-16 rounded-[2rem] border border-white/10 bg-zinc-950 flex flex-col md:flex-row items-center gap-12 justify-between overflow-hidden shadow-2xl">
            <div className="absolute top-0 right-0 p-6 opacity-[0.03] pointer-events-none">
            ...
            <div className="space-y-6 relative z-10 flex-1">
                <div className="flex items-center gap-4 text-accent">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.4em]">Institutional Control Protocol</span>
                </div>
...
export default function TempDesignClientPage() {
    return (
        <main className="flex-1 pb-48 bg-zinc-950">
            {/* LAB HEADER */}
            <header className="w-full py-24 text-center border-b border-white/5">
                <Badge variant="outline" className="text-primary border-primary/30 mb-6 px-6 py-2 rounded-full text-[11px] font-black tracking-[0.3em] uppercase">Resolution Protocol V15</Badge>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="space-y-8">
                        <div className="text-center p-6 border border-white/5 rounded-2xl bg-white/[0.02]">
                            <Badge variant="secondary" className="mb-4">Option 1: The Strategic Solution</Badge>
                            <p className="text-xs text-zinc-500 uppercase font-black tracking-widest">Focus: Resilience & Tailoring</p>
                        </div>
                    ...
                    <div className="space-y-8">
                        <div className="text-center p-6 border border-white/5 rounded-2xl bg-white/[0.02]">
                            <Badge variant="secondary" className="mb-4">Option 2: The Institutional Protocol</Badge>
                            <p className="text-xs text-zinc-500 uppercase font-black tracking-widest">Focus: Backbone & Authority</p>
                        </div>
                        <Resolution_Protocol />
                    </div>
                </div>
            ...
            <Section className="bg-black/40 border-y border-white/5">
                <div className="max-w-4xl mx-auto space-y-16">
                    <div className="space-y-8">
                        ...
                        <p className="text-2xl text-zinc-300 leading-[1.8] font-medium border-l-2 border-primary/20 pl-8 italic">
                    ...
                    <div className="py-40 text-center space-y-6">
                        <figure className="inline-block max-w-3xl">
                            ...
                            />
                            <figcaption className="mt-8 text-[11px] text-zinc-500 uppercase tracking-[0.3em] font-black italic">Exhibit C: Financial Consequence Mapping (16:9 Aspect Ratio • Expansive Spacing)</figcaption>
                        </figure>
                    </div>
