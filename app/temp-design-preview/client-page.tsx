        ...
        <div className="flex flex-col min-h-screen bg-background">
            ...
            <main className="flex-1">
                ...
                <div className="container py-12 px-4 md:px-6">
                    <div className="p-6 rounded-2xl bg-secondary/20 border-2 border-dashed border-primary/20 text-center">
                        <p className="text-sm font-bold text-primary italic">Design Preview Note: The text block above is now vertically centered in the lower 70% of the screen on mobile to eliminate bottom dead space.</p>
                    </div>
                </div>
            </main>
            <Footer />
