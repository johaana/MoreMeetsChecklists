...
export const handleDownloadV2 = (item: PremiumPack) => {
    ...
    const mgrData: any[][] = [
        ...
        [],
        [{ v: "ID", s: headerBlockStyle }, { v: "Operational Requirement", s: headerBlockStyle }, { v: "Assigned Personnel", s: headerBlockStyle }, { v: "Current Status", s: headerBlockStyle }]
    ];
