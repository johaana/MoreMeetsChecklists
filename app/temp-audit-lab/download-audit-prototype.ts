...
export const handleDownloadAuditPrototype = () => {
    try {
        ...
        const guideData: any[][] = [
            ...
            [{ v: "Use the REFERENCE IMAGE column for visual standards so staff can compare Expected ↔ Actual." }],
            [],
            [{ v: "SECTION F — MAINTENANCE & BACKUPS", s: { font: { bold: true, sz: 12 } } }],
            [{ v: "1. Weekly Backup: Go to [File] -> [Make a copy]." }],
