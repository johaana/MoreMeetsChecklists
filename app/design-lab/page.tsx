...
/**
 * SOVEREIGN VALUE STRIP - LIGHT MODE
...
/**
 * UNIVERSAL SECTOR NAVIGATOR - DAYLIGHT
 */
                ...
                <div className="flex-1 grid grid-cols-2 md:grid-cols-7 gap-2 md:gap-3 w-full px-4 md:px-6 h-full py-2">
                    {sectorPoints.map((item, i) => (
                        <Link key={i} href={item.href} className="group/item">
                            <div className="flex flex-col gap-1.5 pl-3 md:pl-4 first:border-0 h-full justify-center border-l border-zinc-100 transition-all overflow-hidden">
                                <span className="text-[6px] md:text-[8px] font-black uppercase tracking-[0.3em] text-zinc-400 whitespace-nowrap">{item.label}</span>
