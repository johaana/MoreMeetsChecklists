...
const DaylightHero = ({ 
    ...
    <section className="relative w-full h-[100dvh] flex flex-col overflow-hidden bg-zinc-100 border-b border-zinc-200">
        ...
        <div className="absolute inset-0 z-0">
            ...
            {/* Fixed Daylight Gradient Mask - Ensures Text Legibility on the left */}
        ...
        {/* Persistent Dual-Strip Footer */}
        <div className="relative z-30 w-full">
            <div className={cn(
                "max-w-7xl mx-auto flex justify-between items-end px-12 pb-4",
                ...
                <span className="hidden md:block text-[9px] font-mono text-zinc-400 uppercase tracking-widest">SOVEREIGN_SYSTEM_V63.0_STABLE</span>
            </div>
