        ...
        <div className="absolute inset-[8px] bg-black rounded-[2rem] overflow-hidden border border-white/5 rotate-x-[8deg] rotate-y-[-10deg] group-hover:rotate-0 transition-transform duration-1000 ease-out">
            ...
            <div className="w-full h-full relative bg-white overflow-hidden">
                <img 
                    ...
                    className="w-full h-full object-cover p-1 group-hover:scale-[1.02] transition-transform duration-1000" 
                />
            </div>
        </div>

        {/* Floating Vitals - Frames the device */}
        <div className="absolute -bottom-6 -right-6 bg-white/80 backdrop-blur-xl p-4 rounded-2xl border border-zinc-200 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-500">
            <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center text-primary">
                    <Activity className="w-4 h-4 animate-pulse" />
                </div>
                <div className="flex flex-col">
                    <span className="text-[9px] font-black text-zinc-400 uppercase tracking-widest leading-none">SYSTEM_STATUS</span>
                    <span className="text-[10px] font-black text-[#0F172A] uppercase italic leading-none mt-1">OPERATIONS SECURED</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div className="flex flex-col min-h-screen bg-white font-body selection:bg-violet-100">
            ...
            <main className="flex-1">
                ...
                <section className="relative w-full h-[100svh] flex flex-col justify-center bg-[#f8fafc] overflow-hidden border-b border-zinc-100 pt-16">
                    {/* Radiant Pastel Mesh - Clean & Unique */}
                        ...
                        <div className="grid lg:grid-cols-[1fr,1.1fr] gap-12 items-center w-full">
                            ...
                            <div className="space-y-4 md:space-y-6 animate-in fade-in slide-in-from-left-4 duration-1000">
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        <div className="w-2.5 h-2.5 rounded-full bg-primary shadow-[0_0_10px_rgba(46,184,107,0.4)]" />
                                        <span className="text-[11px] font-black uppercase tracking-[0.5em] text-zinc-400 font-headline">COMMAND INFRASTRUCTURE ACTIVE</span>
                                    </div>
                                    ...
                                    <p className="text-xl md:text-2xl font-bold italic text-zinc-500 leading-tight border-l-2 border-primary/40 pl-6">
                                        See daily work getting done—even when you’re not there.
                                    </p>
                                </div>

                                {/* Autopilot Feature Block */}
                                <div className="p-6 md:p-8 rounded-3xl bg-[#0F172A] text-white border-l-[8px] border-primary shadow-2xl space-y-2 relative overflow-hidden group">
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className="flex items-center gap-4 py-3 px-6 bg-white border border-zinc-100 rounded-full w-fit shadow-sm">
                    ...
                    <div className="absolute bottom-0 w-full py-4 bg-white/60 backdrop-blur-md border-t border-zinc-100">
                        <div className="container px-12 mx-auto flex justify-center md:justify-between items-center text-[10px] font-black text-zinc-400 uppercase tracking-[0.5em] italic font-headline">
                             ...
                             <span className="hidden md:block">SECURE_BUILD_V210.0</span>
                        </div>
                    </div>
                </section>
                ...
                <Section className="bg-white">
                    <div className="max-w-5xl mx-auto space-y-16">
                        ...
                        <div className="grid md:grid-cols-2 gap-12">
                            <div className="p-10 rounded-[2.5rem] bg-[#fdf2f2] border border-red-100 space-y-8 relative overflow-hidden group">
                            ...
                            <div className="flex flex-col justify-center space-y-10">
                                <div className="space-y-6">
                                    ...
                                    <p className="text-2xl md:text-3xl font-bold italic text-zinc-600 leading-tight border-l-4 border-red-500 pl-8">
                                        "Most operational problems don’t come from big failures. They come from small tasks being missed every day."
                                    </p>
                                </div>
                                <div className="p-8 bg-zinc-50 border border-zinc-100 rounded-3xl text-zinc-400 shadow-sm relative overflow-hidden">
                                    <p className="text-[10px] font-black text-primary uppercase tracking-[0.4em] mb-2 italic">INFRASTRUCTURE MANDATE</p>
                                    <p className="text-lg font-bold italic leading-snug">That is exactly where control is lost. Memory is not a system.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-4xl mx-auto text-center space-y-16">
                        ...
                        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
                            {[
                                ...
                                <div key={i} className="p-8 rounded-[2rem] bg-white border border-zinc-100 space-y-6 text-left shadow-sm hover:border-primary/40 transition-all group">
                                    <div className="w-12 h-12 rounded-xl bg-primary/5 flex items-center justify-center group-hover:scale-110 transition-transform">
                                        <card.i className="w-6 h-6 text-primary" />
                                    </div>
                                    <div className="space-y-2">
                                        <h4 className="font-black text-[#0F172A] uppercase italic tracking-tighter leading-tight text-xl">{card.t}</h4>
                                        <p className="text-sm text-zinc-500 italic font-medium leading-relaxed">{card.d}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                        <div className="flex flex-col md:flex-row justify-center gap-10 md:gap-20 pt-6">
                            <span className="flex items-center justify-center gap-3 text-xs font-black uppercase tracking-widest italic text-zinc-400"><CheckCircle2 className="w-5 h-5 text-primary" /> NO FOLLOW-UPS REQUIRED</span>
                            <span className="flex items-center justify-center gap-3 text-xs font-black uppercase tracking-widest italic text-zinc-400"><CheckCircle2 className="w-5 h-5 text-primary" /> NO DEPENDENCY ON MEMORY</span>
                        </div>
                    </div>
                </Section>
                        ...
                        <div className="grid md:grid-cols-4 gap-10 md:gap-12">
                            {[
                                ...
                                <div key={i} className="space-y-4 relative group">
                                    <div className="text-7xl font-black text-zinc-50 font-headline leading-none group-hover:text-primary/10 transition-colors">{step.s}</div>
                                    <h4 className="font-black text-[#0F172A] uppercase italic tracking-tighter leading-tight text-xl">{step.t}</h4>
                                    <p className="text-sm text-zinc-500 italic font-medium leading-relaxed">{step.d}</p>
                                    {i < 3 && <div className="hidden md:block absolute top-12 -right-8 text-zinc-100"><ArrowRight className="w-8 h-8" /></div>}
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-20 md:gap-24 items-center">
                        <div className="space-y-12">
                            <div className="space-y-4">
                                ...
                                <p className="text-2xl md:text-3xl text-zinc-600 italic font-medium border-l-4 border-primary pl-8 leading-tight">You don’t ask. <br /> You already know.</p>
                            </div>
                            <ul className="space-y-8">
                                {[
                                    ...
                                    <li key={i} className="flex gap-8 group">
                                        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-white border border-zinc-100 group-hover:bg-primary group-hover:text-white transition-all shrink-0 shadow-sm">
                                            <item.i className={cn("w-8 h-8", item.c, "group-hover:text-white")} />
                                        </div>
                                        <div className="space-y-1">
                    ...
                    <div className="max-w-6xl mx-auto space-y-16 md:space-y-20">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                <div key={i} className={cn("p-10 rounded-[2.5rem] bg-[#f8fafc] border border-zinc-100 space-y-5 hover:border-primary/40 transition-all group", item.elite && "border-primary/20 bg-primary/5")}>
                                    <div className="w-12 h-12 rounded-xl bg-white border border-zinc-50 flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-all shadow-sm">
                ...
                <Section className="bg-[#f0f9f4]">
                    <div className="max-w-5xl mx-auto space-y-20">
                        ...
                        <div className="grid md:grid-cols-2 gap-10 md:gap-12">
                            <div className="p-10 rounded-[2.5rem] bg-white border border-zinc-100 flex gap-8 items-start hover:border-primary/40 transition-all group shadow-sm">
                                <div className="w-1.5 h-20 bg-primary rounded-full shrink-0 group-hover:scale-y-110 transition-transform shadow-[0_0_15px_rgba(46,184,107,0.3)]" />
                                <div className="space-y-3">
                                    <h4 className="font-black text-[#0F172A] uppercase tracking-widest text-sm">TRAINER NOTES</h4>
                                    <p className="text-lg text-zinc-600 italic font-bold leading-snug">They explain exactly HOW to do it. Faster onboarding, lower dependency on managers.</p>
                                </div>
                            </div>
                            <div className="p-10 rounded-[2.5rem] bg-white border border-zinc-100 flex gap-8 items-start hover:border-[#f97316]/40 transition-all group shadow-sm">
                                <div className="w-1.5 h-20 bg-[#f97316] rounded-full shrink-0 group-hover:scale-y-110 transition-transform shadow-[0_0_15px_rgba(249,115,22,0.3)]" />
                                <div className="space-y-3">
                                    <h4 className="font-black text-[#0F172A] uppercase tracking-widest text-sm">CONSEQUENCES</h4>
                                    <p className="text-lg text-zinc-600 italic font-bold leading-snug">They explain WHY it matters. Turns mechanical ticking into intentional execution.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-6xl mx-auto space-y-16 md:space-y-20">
                        ...
                        <div className="flex flex-wrap justify-center gap-4 md:gap-6">
                            {[
                                ...
                                <div key={i} className="px-10 py-8 rounded-[2rem] bg-[#f8fafc] border border-zinc-100 flex flex-col items-center gap-4 hover:border-primary/40 hover:bg-white transition-all group shrink-0 shadow-sm">
                                    <ind.i className="w-8 h-8 text-zinc-300 group-hover:text-primary transition-colors" />
                ...
                <Section className="bg-[#0F172A]">
                    <div className="max-w-5xl mx-auto p-12 md:p-24 rounded-[3.5rem] bg-[#1E293B] text-white space-y-12 md:space-y-16 text-center relative overflow-hidden group border border-white/5 shadow-2xl">
                        ...
                        <div className="relative z-10 space-y-6">
                            ...
                            <h2 className="text-4xl md:text-7xl font-black font-headline uppercase italic tracking-tighter leading-tight text-white">This is not <br/> “just Excel”</h2>
                            <p className="text-xl md:text-3xl font-bold italic text-white/60 leading-relaxed max-w-4xl mx-auto">
                        ...
                        <div className="relative z-10 grid md:grid-cols-3 gap-12 text-center border-t border-white/10 pt-16">
                             <div className="space-y-2">
                                <h4 className="text-base font-black uppercase tracking-widest font-headline text-primary">ZERO SOFTWARE DEBT</h4>
                                <p className="text-xs text-white/40 italic font-medium leading-relaxed">Start today, not next month. <br/> No implementation period.</p>
                             </div>
                             <div className="space-y-2">
                                <h4 className="text-base font-black uppercase tracking-widest font-headline text-primary">ZERO SUBSCRIPTION</h4>
                                <p className="text-xs text-white/40 italic font-medium leading-relaxed">Buy once, own it forever. <br/> No per-user monthly bills.</p>
                             </div>
                             <div className="space-y-2">
                                <h4 className="text-base font-black uppercase tracking-widest font-headline text-primary">ZERO COMPLEXITY</h4>
                                <p className="text-xs text-white/40 italic font-medium leading-relaxed">Simple for teams. <br/> Industrial power for managers.</p>
                             </div>
                        </div>
                    </div>
                </Section>
                    ...
                    <div className="max-w-3xl mx-auto space-y-16">
                        ...
                        <Accordion type="single" collapsible className="w-full">
                            <AccordionItem value="lock" className="border-zinc-100">
                                <AccordionTrigger className="text-xl font-black uppercase italic tracking-tighter text-[#0F172A] hover:no-underline py-8 text-left">Can my team accidentally change or break the system?</AccordionTrigger>
                ...
                <Section className="bg-[#f8fafc] border-t border-zinc-100 py-24 text-center">
                    <div className="max-w-4xl mx-auto space-y-12 relative z-10">
                        <div className="space-y-6">
                            <Badge className="bg-primary text-white border-none uppercase tracking-[0.5em] font-black text-[12px] px-12 py-2.5 rounded-full">Secure Your Operations</Badge>
                            ...
                            <p className="text-xl md:text-2xl text-zinc-400 italic font-medium">Setup takes less than 10 minutes. <br/> Customization support available.</p>
                        </div>
                        
                        <div className="space-y-10">
                            <div className="flex flex-col items-center gap-6">
                                <div className="flex items-baseline gap-6">
                                    <span className="text-6xl md:text-8xl font-black text-primary italic font-headline leading-none">₹2,999</span>
                                    <span className="text-2xl md:text-4xl font-bold text-zinc-200 line-through italic leading-none">₹4,999</span>
                                </div>
                                <div className="flex items-center gap-10 text-xs font-black text-zinc-300 uppercase tracking-[0.3em]">
                            ...
                            <Button asChild size="lg" className="h-24 px-16 rounded-[2rem] bg-[#f97316] text-white font-black uppercase italic tracking-widest text-2xl shadow-[0_25px_50px_-10px_rgba(249,115,22,0.4)] hover:scale-105 transition-all border-none">
