...
const HeroVariation = ({ id, badge, accentColor, glowClass }: any) => (
    <section id={id} className="relative w-full min-h-screen flex flex-col justify-center overflow-hidden bg-black border-b border-white/5">
        {/* Full-Clarity Cinematic Video Backdrop */}
        ...
        <div className="container px-6 relative z-10 mx-auto">
            <div className="max-w-xl relative group"> 
                {/* Layered Technical Glow */}
                <div className={cn("absolute -inset-20 rounded-full blur-[120px] opacity-20 group-hover:opacity-40 transition-opacity duration-1000 animate-pulse-soft", glowClass)} />
                
                {/* 40% Hyper-Translucent Glass Card with Rim Lighting */}
                <div className="relative z-10 p-10 md:p-16 rounded-[3.5rem] border border-white/20 border-t-white/60 border-l-white/60 bg-white/40 backdrop-blur-[100px] space-y-10 shadow-[0_20px_50px_rgba(0,0,0,0.3),inset_0_1px_2px_rgba(255,255,255,0.5)] transition-all duration-500 hover:bg-white/45">
                    <div className="space-y-8">
                        <div className="w-20 h-1.5 rounded-full opacity-60" style={{ backgroundColor: accentColor }} />
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-lg md:text-xl text-zinc-800 italic font-medium leading-relaxed border-l-4 border-zinc-400/30 pl-8">
                    ...
                    <Button 
                        className="h-20 px-12 font-black uppercase italic rounded-2xl border-none shadow-2xl hover:scale-[1.02] active:scale-95 transition-all w-full text-lg tracking-widest text-white" 
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 text-center">
            <p className="text-[10px] font-black uppercase tracking-[0.5em] text-white/40">{badge}</p>
        </div>
    </section>
);

const TaskSnippetGlass = ({ title, audit, action, risk, accentColor }: any) => (
    <div className="p-10 rounded-[3rem] border border-white/20 border-t-white/60 border-l-white/60 bg-white/40 backdrop-blur-[80px] shadow-xl space-y-8 hover:bg-white/60 transition-all group flex flex-col justify-between h-full">
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <main className="flex-1">
                ...
                {/* ARCHETYPE 1: PLATINUM EXECUTIVE (Prestige) */}
                <HeroVariation 
                    id="gold"
                ...
                <HeroVariation 
                    id="orchid"
                    badge="4. Electric Orchid (Tech)"
                    glowClass="bg-purple-600/40"
                    accentColor="#9333ea"
                />

                {/* ARCHETYPE 5: IRON SLATE (Industrial) */}
                <HeroVariation 
                    id="slate"
                    badge="5. Iron Slate (Industrial)"
                ...
                <section className="py-24 md:py-32 bg-zinc-50 relative overflow-hidden">
                    ...
                    <div className="container px-6 mx-auto relative z-10">
                        <div className="max-w-4xl mx-auto text-center space-y-4 mb-20">
                            <Badge variant="outline" className="uppercase tracking-[0.4em] font-black text-[10px] border-zinc-300 text-zinc-500 px-6 py-1.5 rounded-full bg-white/50">Hyper-Glass Components</Badge>
                            <h2 className="text-4xl md:text-7xl font-black font-headline uppercase italic tracking-tighter text-zinc-900 leading-[0.9]">Universal <br /> Grid Standards</h2>
                            <p className="text-lg md:text-xl text-zinc-600 italic font-medium max-w-xl mx-auto leading-relaxed">High-contrast data points on refractive glass blocks. Optimized for executive ocular comfort.</p>
                        </div>
