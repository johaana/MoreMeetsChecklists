...
const DesktopCTA = () => (
    <div className="flex flex-col md:flex-row items-center gap-6">
        <button className="h-16 px-12 rounded-xl bg-primary text-black font-black uppercase italic text-sm shadow-[0_0_50px_-5px_rgba(46,184,107,0.5)] hover:scale-105 active:scale-95 transition-all border-none group flex items-center justify-center gap-3">
            DEPLOY MASTER ENGINE → ₹2,999 <ArrowRight className="w-5 h-5 transition-transform group-hover:translate-x-1" />
        </button>
        ...
        <div className="bg-[#050505] text-white">
            ...
            <div className="container px-6 pt-32 pb-20 mx-auto text-center space-y-6">
                ...
                <p className="text-zinc-500 italic font-medium max-w-2xl mx-auto text-lg leading-relaxed">
                    Testing 5 strategic visual archetypes for the MoreMeets™ Institutional Standard. Each design is engineered for high-gravity professional conversion.
                </p>
            </div>
            ...
            <LabSection 
                ...
                subtitle="High-density 50/50 industrial contrast. Narrative on black, action on desaturated video."
            >
                <div className="flex h-full flex-col md:flex-row">
                    ...
                    <div className="flex-1 relative overflow-hidden h-full">
                        ...
                        <div className="absolute top-10 right-10 z-20 flex flex-col items-end gap-1 opacity-20">
                            <span className="text-[8px] font-mono tracking-widest">OS_VERSION_V80.0</span>
            ...
            <LabSection 
                ...
                subtitle="Light-themed, technical focus. High-contrast line art and scientific framing."
            >
                <div className="h-full bg-zinc-100 flex items-center justify-center p-6 md:p-20 relative">
                    ...
                    <div className="container mx-auto grid md:grid-cols-2 gap-20 items-center relative z-20">
                        ...
                        <div className="relative group">
                            <div className="absolute -inset-10 border border-zinc-200 rounded-full animate-pulse-soft pointer-events-none" />
                            ...
                            {/* Callouts */}
                            <div className="absolute top-0 right-0 bg-white p-4 shadow-xl border border-zinc-100 rounded-2xl animate-in zoom-in duration-1000 delay-500">
                        ...
                        <div className="max-w-5xl space-y-12">
                            <div className="space-y-6">
                                <h1 className="text-6xl md:text-[9rem] font-black font-headline tracking-tighter leading-[0.8] uppercase italic text-white drop-shadow-2xl">
                                    CAPTURE<br /><span className="text-primary animate-pulse-soft">MEMORY.</span>
                                </h1>
            ...
            <LabSection 
                ...
                subtitle="Ultra-wide layout with vertical strategic labels. Prestigious enterprise standard."
            >
                <div className="h-full bg-zinc-950 flex flex-col justify-center relative px-12 md:px-32">
                    ...
                    <div className="relative z-20 grid grid-cols-[1fr,400px] gap-20 items-center">
                        ...
                        <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-12 rounded-[3rem] space-y-8 shadow-2xl">
                             <span className="text-[11px] font-black text-primary uppercase tracking-[0.4em]">SELECT VERTICAL</span>
            ...
            <LabSection 
                ...
                subtitle="Cleanest authoritative look. Bold desaturated typography over raw industrial grain."
            >
