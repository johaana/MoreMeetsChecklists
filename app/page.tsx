...
const Section = ({ className, id, children, ...props }: React.HTMLAttributes<HTMLElement> & { id?: string }) => (
    <section id={id} className={cn("w-full py-12 md:py-24", className)} {...props}>
...
const HeroSection = () => {
    ...
    return (
        <section className="relative w-full flex flex-col items-center h-[calc(100dvh-64px)] md:h-[calc(100vh-64px)] md:min-h-[650px] overflow-hidden bg-background">
            ...
            {/* Content Layer - v7.3 Sovereign Build */}
            <div className="container px-4 md:px-6 relative z-20 flex-1 flex flex-col justify-center">
                <div className="max-w-3xl space-y-3 md:space-y-4">
                    ...
                    <div className="space-y-3 md:space-y-5">
                        ...
                        <div className="p-6 md:p-10 rounded-3xl bg-white/[0.02] border border-white/5 w-fit shadow-2xl backdrop-blur-sm relative overflow-hidden group">
                            ...
                            {mounted && (
                                <p className="text-[10px] uppercase font-black text-white/40 mt-8 tracking-[0.2em] relative z-10 italic border-t border-white/5 pt-4">
                                    WORKS ON EXCEL / GOOGLE SHEETS • NO SAAS LOCK-IN
                                </p>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="pt-2 md:pt-4">
                        <Button size="lg" asChild className="group h-12 md:h-16 px-8 md:px-12 rounded-xl shadow-[0_0_40px_-10px_rgba(46,184,107,0.5)] transition-all active:scale-95 bg-primary text-black hover:brightness-95 font-black uppercase text-sm md:text-base tracking-[0.1em] border-none">
                            <Link href="/library" className="flex items-center justify-center">
                                GET YOUR SYSTEM — $9 ONLY <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
                            </Link>
                        </Button>
                        ...
                        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 pt-5 md:pt-7">
                            {[
                                ...
                                { text: "No SaaS Bills", icon: Lock },
                                { text: "Distributed Discipline", icon: Users },
                                { text: "Audit-Ready", icon: ShieldCheck }
                            ].map(item => (
...
const ClaritySection = () => (
    <Section className="bg-alternate-background border-y border-white/5">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
                { t: "Team Knows Exactly What to Do", d: "Technical missions are assigned to the 8-Role Matrix. Steps are clear. Memory is removed from the equation.", i: ClipboardCheck },
                { t: "Tasks Completed in Seconds", d: "Accountability is built into the pulse. Two minutes at end of shift, and the data moves to you instantly.", i: Timer },
                { t: "Dashboards Update Automatically", d: "No manual collation. No data entry for the owner. Open one file and see your entire empire live.", i: Zap }
            ].map(item => (
...
const ReportingChainSection = () => (
    <Section id="kill-reporting" className="bg-black border-y border-white/5">
        <div className="text-center mb-20 max-w-3xl mx-auto space-y-4">
            ...
            <p className="text-secondary-text text-lg italic font-medium">The owner receives zero reports because the dashboard is already live.</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-px bg-white/5 border border-white/5 rounded-[3.5rem] overflow-hidden max-w-6xl mx-auto shadow-2xl">
            <div className="bg-black/40 p-12 md:p-20 space-y-12">
                <div className="space-y-2">
                    <h3 className="text-red-500 font-black uppercase tracking-widest text-sm flex items-center gap-2">
                        <X className="w-5 h-5" /> The Old World (Chasing)
                    </h3>
                ...
                <div className="space-y-8 relative">
                    ...
                    <div className="pt-8 border-t border-white/5">
                        <p className="text-red-500 font-black italic text-base">Result: ❌ Delayed, ❌ Guesswork, ❌ Burnout</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-primary/5 p-12 md:p-20 space-y-12 border-l border-primary/20">
                <div className="space-y-2">
                    ...
                    <p className="text-xs text-primary/40 italic">Data moves from the floor to your screen in 0 seconds.</p>
                </div>

                <div className="space-y-8">
                    {[
                        "Staff marks technical mission 'Done'",
                        "Sovereign Engine updates instantly",
                        "Dashboard signals 'Empire Mood' live",
                        "Zero manual reports ever required."
                    ].map((step, i) => (
                    ...
                    <div className="pt-8 border-t border-white/5">
                        <p className="text-primary font-black italic text-base">Result: ✅ Real-time Clarity, ✅ Zero Collation</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <Section id="superpowers" className="bg-alternate-background border-y border-white/5">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {[
                ...
                { t: "The 8-Role Matrix", d: ["Distributed discipline across departments", "EHS, Accountant, and Admin specialized", "Removes the 'Hero Manager' bottleneck"], p: "Systems, not heroes.", i: Users },
                { t: "Institutional Memory", d: ["New staff ready from Day 1", "Trainer notes capture the 'How'", "Knowledge stays if people leave"], p: "Protect the brand.", i: GraduationCap },
                ...
                { t: "No-SaaS Freedom", d: ["No monthly subscriptions", "No logins or passwords", "One-time payment, own forever"], p: "Zero recurring cost.", i: Lock },
            ...
            <div className="space-y-10">
                <div className="space-y-6">
                    ...
                    <p className="text-xl text-secondary-text italic font-medium leading-relaxed">
                        MoreMeets is engineered to meet real-world operational standards (ISO, HACCP, OSHA) across 7 high-stakes elite sectors.
                    </p>
                </div>
                <div className="grid grid-cols-2 gap-6">
                    {[
                        ...
                        { t: "Institutional Memory", i: History },
                        { t: "Logic-Aware Engine", i: Database }
                    ].map(item => (
                ...
                <div className="flex flex-col items-center gap-8">
                    <Button size="lg" asChild className="group h-24 px-16 rounded-[2rem] bg-primary text-black font-black uppercase text-2xl shadow-[0_0_60px_-10px_rgba(46,184,107,0.6)] hover:scale-105 active:scale-95 transition-all">
                        <Link href="/library" className="flex items-center">
                            Deploy Sovereign OS — $9 <ArrowRight className="ml-4 h-8 w-8" />
                        </Link>
                    </Button>
