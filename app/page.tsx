    ...
    <Section className="bg-black border-y border-white/5">
        <div className="max-w-6xl mx-auto space-y-16">
            <div className="text-center space-y-4">
                <Badge variant="outline" className="text-primary border-primary/30 uppercase tracking-[0.3em] font-black text-[11px]">Industrial Payload</Badge>
            ...
            <div className="p-10 rounded-[3rem] bg-primary/5 border border-primary/20 text-center relative overflow-hidden">
                ...
                <p className="text-base md:text-lg font-black text-primary uppercase tracking-[0.3em] italic relative z-10">
...
const HowItWorksSection = () => (
    <Section id="how-it-works" className="bg-alternate-background relative overflow-hidden">
        <div className="max-w-6xl mx-auto space-y-20 relative z-10">
            <div className="text-center space-y-4">
                <Badge variant="outline" className="text-accent border-accent/30 uppercase tracking-[0.3em] font-black text-[11px]">Seamless Implementation</Badge>
                    ...
                    <div key={i} className="relative space-y-6 group z-10">
                        <div className="flex flex-col items-center md:items-start gap-4">
                            ...
                            <div className="space-y-2 text-center md:text-left">
                                ...
                                <p className="text-xs text-secondary-text leading-relaxed font-medium italic opacity-80 group-hover:opacity-100 transition-opacity">{step.d}</p>
                            </div>
                        </div>
                    </div>
                ))}
            ...
            <div className="flex flex-col items-center gap-4">
                <p className="text-center text-[11px] font-black text-white/20 uppercase tracking-[0.4em]">NO TRAINING • NO ONBOARDING • NO DELAY</p>
...
const WhyTeamFollowsSection = () => (
    <Section className="bg-alternate-background border-t border-white/5">
        <div className="max-w-4xl mx-auto space-y-16">
            <div className="text-center space-y-4">
                <Badge variant="outline" className="text-accent border-accent/30 uppercase tracking-[0.3em] font-black text-[11px]">Human-Centric Design</Badge>
            ...
            <div className="grid gap-6">
                {[
                    { l: "THE PROTOCOL", t: "WHAT TO DO", d: "Technical standards mapped to global requirements, translated into plain English.", i: ClipboardCheck },
                    ...
                    <div key={i} className="flex flex-col md:flex-row items-center gap-8 p-10 rounded-[3rem] bg-black border border-white/5 group hover:border-primary/20 transition-all">
                        ...
                        <div className="space-y-1 flex-1 text-center md:text-left">
                            <span className="text-[11px] font-black text-white/20 uppercase tracking-widest">{item.l}</span>
...
const WhyMoreMeetsSection = () => (
    <Section className="bg-black">
        <div className="max-w-5xl mx-auto space-y-16">
            <div className="text-center space-y-4">
                <Badge variant="outline" className="text-primary border-primary/30 uppercase tracking-[0.3em] font-black text-[11px]">The Structural Moat</Badge>
            ...
            <div className="grid md:grid-cols-2 gap-12 relative">
                ...
                <div className="space-y-8 p-8 rounded-[2rem] bg-red-500/[0.03] border border-red-500/10">
                    <h3 className="text-red-500/60 font-black uppercase tracking-widest text-[11px] text-center italic">SYSTEMS THAT FAIL</h3>
                ...
                <div className="space-y-8 p-8 rounded-[2rem] bg-primary/[0.02] border border-primary/10">
                    <h3 className="text-primary font-black uppercase tracking-widest text-[11px] text-center italic">THE MOREMEETS WAY</h3>
                    <div className="space-y-6">
                        {[
                            ...
                            <div key={item} className="flex items-center gap-4 text-base text-primary-text font-bold uppercase italic tracking-tight">
                ...
                <div className="flex flex-col items-center">
                    <Button size="lg" asChild className="group h-24 px-16 rounded-[2rem] bg-primary text-black font-black uppercase text-2xl shadow-[0_0_60px_-10px_rgba(46,184,107,0.6)] hover:scale-105 active:scale-95 transition-all border-none">
                        <Link href="/library" className="flex flex-col items-center justify-center gap-1">
                            ...
                            <div className="text-[11px] font-bold opacity-60">~ PRE-BUILT. EDITABLE. READY TO RUN. ~</div>
                        </Link>
                    </Button>
                    <p className="text-[11px] font-black text-white/20 mt-10 uppercase tracking-[0.4em]">ONE-TIME DEPLOYMENT OFFER: ₹999 (LAUNCH PRICING)</p>
                </div>
            </div>
        </div>
    </Section>
