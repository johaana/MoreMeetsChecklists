...
const WhyDetailMatters = () => {
    const points = [
        {
            icon: <AlertTriangle />,
            problem: "One Missed Step Costs Everything",
            solution: "With MoreMeets, you have a verifiable system that turns best practices into daily habits, preventing compliance fines, safety incidents, and revenue loss before they happen.",
        },
        {
            icon: <Users />,
            problem: "Your Team Can't Read Your Mind",
            solution: "Without a guide, small deviations lead to inconsistent quality. MoreMeets translates your high standards into clear, actionable steps for everyone.",
        },
        {
            icon: <Shield />,
            problem: "An Auditor's Visit Causes Panic",
            solution: "Our checklists are built by veterans who know regulations (NABH, JCI, ISO) inside out, providing a clear, documented trail of diligence that makes you audit-ready, always.",
        },
         {
            icon: <FileText />,
            problem: "You Need SOPs, But It's Overwhelming",
            solution: "We've done the hard work. Our packs are expert-built foundations that are 90% of the way there, saving you weeks of work and giving you a professional framework from day one.",
        },
        {
            icon: <BarChart />,
            problem: "You're Stuck Managing Problems",
            solution: "Every minute spent fixing preventable errors is a minute not spent on growth. Our checklists reduce operational friction, freeing your team to innovate and focus on customers.",
        },
        {
            icon: <Award />,
            problem: "Your Business Relies on One 'Hero' Manager",
            solution: "What happens if your indispensable manager leaves? MoreMeets democratizes expertise, creating a scalable system where anyone on your team can operate at a high standard.",
        }
    ];
