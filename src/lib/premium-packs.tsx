...
export const premiumPacks: PremiumPack[] = [
        ...
        checklists: [
            ...
            },
            {
                ...
                tasks: [
                    ...
                    { id: 'LEGAL-09', description: 'Draft location agreements and releases.', priority: 'High', riskLevel: 'High', consequence: 'Protects the production from legal claims from the property owner.', proof: 'Location Agreements', location: 'Legal File' },
            ...
            },
            {
            ...
            },
             {
                ...
                tasks: [
                    ...
                    { id: 'CCM-05', description: 'Process timesheets and expense reports.', priority: 'High', riskLevel: 'High', consequence: 'Late or inaccurate payments are a major source of crew disputes.', proof: 'Approved Timesheets', location: 'Accounts' },
    ...
    },
    {
        ...
        competitorPriceUSD: 599,
        paymentId: 'pl_JvAOrzC7sS2fG9',
        lemonSqueezyUrl: 'https://moremeets.lemonsqueezy.com/buy/28b7f354-6677-48a3-a34e-b249c29a184d',
        category: "Entertainment & Events",
