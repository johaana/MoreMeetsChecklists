...
export const checklistTemplates: Checklist[] = [
  // Events
  {
    ...
    type: 'Wedding - Haldi',
    tasks: [
      { id: '1', text: 'Book venue & confirm guest capacity', completed: true },
      { id: '2', text: 'Arrange turmeric, sandalwood paste & other essentials', completed: true },
      { id: '3', text: 'Hire photographer & videographer', completed: true },
      ...
      { id: '7', text: 'Send out digital invitations and track RSVPs', completed: true },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: '2', text: 'Arrange comfortable seating (floor cushions, low seats)', completed: true },
  ...
  },
   {
    ...
    tasks: [
        { id: '1', text: 'Book DJ, live band, or emcee for the evening', completed: true },
        { id: '2', text: 'Set up stage, sound system, and lighting', completed: true },
        { id: '3', text: 'Create and share rehearsal schedule for all performances', completed: true },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: '2', text: 'Design and print branding materials (banners, backdrops)', completed: true },
  ...
  // Hospitality
  {
    ...
    tasks: [
      { id: '1', text: 'Clean and sanitize guest rooms (beds, bathroom, surfaces)', completed: true, requiresPhoto: true },
      { id: '2', text: 'Restock amenities (towels, toiletries, tea/coffee, water)', completed: true, requiresPhoto: true },
