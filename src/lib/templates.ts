...
export const checklistTemplates: Checklist[] = [
  ...
  // Hospitality
  {
    ...
    items: [
      { id: '1', text: 'Clean and sanitize guest room', completed: true, subtasks: [
      ...
      { id: '2', text: 'Restock amenities', completed: true, subtasks: [
  ...
  },
  {
    ...
    items: [
      ...
      { id: '2', text: 'Deep clean and sanitize all kitchen surfaces and equipment', completed: true },
  ...
  },
  {
    ...
    items: [
      { id: '1', text: 'Clean and sanitize all kitchen stations, grills, and surfaces', completed: true },
    ...
    // Sustainability (Example)
  {
    ...
    items: [
      { id: '1', text: 'Audit and ensure lights are switched off in all unused areas', completed: true },
