...
export const painPointsContent = {
    bakery_confectionery_pack: {
     ...
     franchise_operations_pack: {
        ...
        disclaimer: "*The following real-world incidents are cited based on publicly available news reports and investigation findings for educational and illustrative purposes only.*",
        points: [
            { icon: <Eye />, title: "The Brand Dilution Disaster (Subway's 'Footlong' Scandal, USA)", description: "Multiple Subway franchisees were caught using bread shorter than 12 inches, leading to class-action lawsuits and a PR crisis that damaged the brand's core promise. Our 'Brand Audit' and 'Supply Chain SOPs' enforce portion control and supplier compliance, protecting your brand integrity." },
    ...
    fashion_and_apparel_retail: {
        ...
        points: [
            ...
            { icon: <Siren />, title: "The Primark Fire (Belfast, 2018)", description: "A massive fire destroyed a historic Primark building, costing hundreds of millions. The fire's spread was linked to the building's materials and construction. Our 'Fire Safety' and 'Facility Maintenance' checklists enforce rigorous safety standards for retail spaces." },
    ...
    electronics_showroom_pack: {
        ...
        points: [
            ...
            { icon: <Shield />, title: "The Best Buy 'Geek Squad' Data Theft (USA, 2018)", description: "Employees were accused of copying customers' personal data from devices brought in for repair, leading to lawsuits and a loss of trust. Our 'Repair & Service Management' SOPs create a secure, documented process that protects customer data." },
            { icon: <Bug />, title: "Theft via Inventory Loopholes (Best Buy, USA, 2019)", description: "A sophisticated theft ring stole over $43 million in goods by exploiting inventory control weaknesses. Our 'Asset Tagging' and 'Inventory Reconciliation' SOPs make such large-scale theft impossible by creating a verifiable trail for every high-value item." },
            { icon: <Wrench />, title: "The Unsafe Installation (Generic Example)", description: "An employee is injured, or a customer's property is damaged, during an unsupervised product installation. Our SOPs ensure that all installations are performed by trained staff following a strict, documented safety protocol." }
        ]
    },
    ...
    enterprise_risk_cybersecurity_pack: {
        ...
        disclaimer: "*The following real-world incidents are cited based on publicly available news reports and investigation findings for educational and illustrative purposes only.*",
        points: [
            { icon: <Siren />, title: "AIIMS Cyberattack (India, 2022)", description: "The hospital's systems were down for weeks due to a ransomware attack, with no clear backup restoration SOP. Our 'Incident Response' and 'Backup & Recovery' checklists are designed to handle exactly this scenario." },
    ...
    logistics_warehouse_pack: {
        ...
        points: [
            ...
            { icon: 'info', title: "Flipkart Hub Injury (Bengaluru, 2021)", description: "A worker was severely injured by a falling pallet due to improper stacking. Our 'Daily Warehouse Inspection' checklist includes checks for pallet stability and stacking height to prevent such accidents." },
            { icon: <Building />, title: "Beirut Port Explosion (Lebanon, 2020)", description: "A catastrophic explosion was caused by improperly stored chemicals in a warehouse, a failure of basic safety SOPs. Our checklists for hazardous materials ensure this never happens." },
            { icon: <Wrench />, title: "FedEx Hub Conveyor Belt Accident (USA, 2020)", description: "Two workers were injured by a conveyor belt malfunction. Our 'Lifting and Handling Training' and equipment maintenance checklists prevent such machinery-related accidents." }
        ]
    },
    animal_shelter_pack: {
