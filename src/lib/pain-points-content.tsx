...
export const painPointsContent = {
    ...
    electronics_showroom_pack: {
        ...
        disclaimer: "*The following real-world incidents are cited based on publicly available news reports and investigation findings for educational and illustrative purposes only.*",
        points: [
            { icon: <Zap />, title: "Fire & Electrical Safety (Croma, India, 2017)", description: "A massive fire at a Croma store in Mumbai was attributed to an electrical short circuit, causing millions in inventory loss. Our SOPs for Electrical Safety and Demo Unit checks prevent the overloaded circuits and faulty wiring that lead to such fires." },
            { icon: <Shield />, title: "Data Privacy & Repair Fraud (Best Buy, USA, 2018)", description: "Best Buy faced lawsuits after 'Geek Squad' employees were accused of copying customers' sensitive data from devices in for repair. Our 'Repair & Service Management' SOP creates a strict chain of custody, protecting customer data and your brand from legal damage." },
