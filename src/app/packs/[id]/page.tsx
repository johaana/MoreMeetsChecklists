...
import { ArrowLeft, FileCheck2, Sparkles, Check, X, BadgeCheck, Repeat, Clock, Download, DollarSign } from 'lucide-react';
...
const DownloadHandler = ({ pack }: { pack: PremiumPack }) => {
    'use client';
