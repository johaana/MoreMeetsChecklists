...
export default function SignupPage() {
  ...
  const { toast } = useToast();
   ...
   useEffect(() => {
    ...
    const isProduction = host.includes('web.app') || host.includes('firebaseapp.com');
    setShowGoogleButton(isProduction);
  }, []);
  ...
  const handleGoogleSignIn = async () => {
    ...
    if (error) {
      ...
      toast({
        ...
        description:
          error || 'Could not sign you in with Google. Please try again.',
      });
      return;
    }
    router.push('/dashboard');
