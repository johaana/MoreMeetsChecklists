            ...
            <div className="container px-4 md:px-6">
                ...
                <div className="max-w-3xl mx-auto space-y-8">
                    ...
                    <LegalSection title="3. Purchases and Payment">
                        ...
                        <p>
                            <strong>All sales of our digital Products are final. Due to the digital nature of our Products, we do not offer refunds or exchanges once a purchase is made.</strong>
                        </p>
                    </LegalSection>
                    ...
                    <LegalSection title="4. Prohibited Activities">
                       <p>You may not access or use the Site for any purpose other than that for which we make the Site available. As a user of the Site, you agree not to:</p>
                        <ul className="list-disc pl-6 space-y-2">
                            <li>Resell, sublicense, or redistribute our Products.</li>
                    ...
                    <LegalSection title="5. Disclaimer of Warranties">
                        <p>The Site and our Products are provided on an "AS IS" and "AS AVAILABLE" basis. MoreMeets makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties, including without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights. Further, MoreMeets does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on its website or otherwise relating to such materials or on any sites linked to this site.</p>
                    </LegalSection>
                    ...
                    <LegalSection title="7. Legal Disclaimer">
                    ...
                    <LegalSection title="9. Contact Us">
                        <p>
                            To resolve a complaint regarding the Site or to receive further information regarding use of the Site, please contact us at: <a href="mailto:legal@moremeets.com" className="text-primary underline">legal@moremeets.com</a>
                        </p>
                    </LegalSection>
                </div>
            </div>
